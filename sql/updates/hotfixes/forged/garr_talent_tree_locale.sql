...
-- Dumping structure for table hotfix_bk.garr_talent_tree_locale
DROP TABLE IF EXISTS `garr_talent_tree_locale`;
CREATE TABLE IF NOT EXISTS `garr_talent_tree_locale` (
...
-- Dumping data for table hotfix_bk.garr_talent_tree_locale: ~0 rows (approximately)

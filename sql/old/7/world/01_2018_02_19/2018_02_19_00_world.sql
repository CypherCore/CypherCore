...
ALTER TABLE `guild_rewards` 
  ADD `RaceMask_new` bigint(20) unsigned DEFAULT '0' AFTER `RaceMask`;
...
ALTER TABLE `quest_poi` 
  ADD `AlwaysAllowMergingBlobs` tinyint(1) unsigned NOT NULL DEFAULT '0' AFTER `WoDUnk1`;
...
ALTER TABLE `race_unlock_requirement` 
  ADD `achievementId` int(10) unsigned NOT NULL DEFAULT '0';

...
namespace Game.DataStorage
{
	...
	{
		private Dictionary<uint, ConversationLineTemplate> _conversationLineTemplateStorage = new();

		private Dictionary<uint, ConversationTemplate> _conversationTemplateStorage = new();

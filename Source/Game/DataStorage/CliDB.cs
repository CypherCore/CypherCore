...
namespace Game.DataStorage
{
    public class CliDB
    {
        public static BitSet LoadStores(string dataPath, Locale defaultLocale)
        {
            ...
            ModifiedCraftingItemStorage = ReadDB2<ModifiedCraftingItemRecord>("ModifiedCraftingItem.db2", HotfixStatements.SEL_MODIFIED_CRAFTING_ITEM);
            ...
            TraitTreeStorage = ReadDB2<TraitTreeRecord>("TraitTree.db2", HotfixStatements.SEL_TRAIT_TREE, HotfixStatements.SEL_TRAIT_TREE_LOCALE);
        ...
        public static DB6Storage<CraftingQualityRecord> CraftingQualityStorage;
        ...
        public static DB6Storage<ModifiedCraftingItemRecord> ModifiedCraftingItemStorage;

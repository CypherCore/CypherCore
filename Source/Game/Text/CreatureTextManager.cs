...
namespace Game
{
    ...
    {
        private readonly Dictionary<CreatureTextId, CreatureTextLocale> mLocaleTextMap = new();

        private readonly Dictionary<uint, MultiMap<byte, CreatureTextEntry>> mTextMap = new();

...
namespace Game
{
	...
	{
		private static int AnyMap = -1;
		private Dictionary<int, int> _realmWorldStateValues = new();
		private Dictionary<int, Dictionary<int, int>> _worldStatesByMap = new();

		private Dictionary<int, WorldStateTemplate> _worldStateTemplates = new();

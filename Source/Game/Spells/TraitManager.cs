...
namespace Game
{
	internal class TraitMgr
	{
		...
		private static Dictionary<int, NodeGroup> _traitGroups = new();
		private static Dictionary<int, Node> _traitNodes = new();
		private static Dictionary<int, Tree> _traitTrees = new();
		private static int[] _skillLinesByClass = new int[(int)Class.Max];
		private static MultiMap<int, Tree> _traitTreesBySkillLine = new();
		private static MultiMap<int, Tree> _traitTreesByTraitSystem = new();
		private static int _configIdGenerator;
		private static MultiMap<int, TraitCurrencySourceRecord> _traitCurrencySourcesByCurrency = new();
		private static MultiMap<int, TraitDefinitionEffectPointsRecord> _traitDefinitionEffectPointModifiers = new();
		private static MultiMap<int, TraitTreeLoadoutEntryRecord> _traitTreeLoadoutsByChrSpecialization = new();

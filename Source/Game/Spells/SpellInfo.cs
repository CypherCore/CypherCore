...
namespace Game.Spells
{
    public class SpellInfo
    {
        ...
        public bool IsRangedWeaponSpell()
        {
            return (SpellFamilyName == SpellFamilyNames.Hunter && !SpellFamilyFlags[1].HasAnyFlag(0x10000000u)) // for 53352, cannot find better way
                ...
                || HasAttribute(SpellAttr0.UsesRangedSlot);
        }
        ...
        public SpellCastResult CheckTarget(WorldObject caster, WorldObject target, bool Implicit = true)
        {
            ...
            if (unitTarget != null)
            {
                ...
                if (HasAttribute(SpellAttr9.TargetMustBeGrounded)
                    && unitTarget.HasUnitMovementFlag(MovementFlag.Falling | MovementFlag.Swimming | MovementFlag.Flying | MovementFlag.Hover | MovementFlag.AdvFlying))
    ...
    public class SpellEffectInfo
    {
        ...
        static StaticData[] _data = new StaticData[(int)SpellEffects.TotalSpellEffects]
        {
            ...
            new StaticData(SpellEffectImplicitTargetTypes.Explicit, SpellTargetObjectTypes.Unit), // 311 SPELL_EFFECT_SKIP_QUESTLINE

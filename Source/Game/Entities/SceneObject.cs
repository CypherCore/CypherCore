...
namespace Game.Entities
{
    public class SceneObject : WorldObject
    {
        ...
        void BuildValuesUpdateForPlayerWithMask(UpdateData data, UpdateMask requestedObjectMask, UpdateMask requestedSceneObjectMask, Player target, bool ignoreNestedChangesMask)
        {

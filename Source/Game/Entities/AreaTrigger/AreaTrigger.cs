...
namespace Game.Entities
{
	public class AreaTrigger : WorldObject
	{
		...
		private AreaTriggerFieldData _areaTriggerData;
		private AreaTriggerTemplate _areaTriggerTemplate;

		private AuraEffect _aurEff;
		private int _duration;
		private List<ObjectGuid> _insideUnits = new();
		...
		{
			private AreaTriggerFieldData AreaTriggerMask = new();
			private ObjectFieldData ObjectMask = new();
			private AreaTrigger Owner;

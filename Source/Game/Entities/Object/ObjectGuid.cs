...
namespace Game.Entities
{
	...
	{
		private static Dictionary<HighGuid, string> Names = new();
		private static Dictionary<HighGuid, Func<HighGuid, ObjectGuid, string>> ClientFormatFunction = new();
		private static Dictionary<HighGuid, Func<HighGuid, string, ObjectGuid>> ClientParseFunction = new();

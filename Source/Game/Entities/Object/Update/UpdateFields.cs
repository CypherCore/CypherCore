...
namespace Game.Entities
{
    ...
    public class PlayerData() : HasChangesMask((int)EntityFragment.CGObject, TypeId.Player, 324)
    {
        ...
        public UpdateField<int> Favor = new(32, 45);
    ...
    {
        public UpdateField<uint> PlotID = new(0, 1);

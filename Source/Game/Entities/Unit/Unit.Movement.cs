...
namespace Game.Entities
{
    public partial class Unit
    {
        ...
        public bool SetDisableGravity(bool disable, bool updateAnimTier = true, bool updatePlayHoverAnim = true)
        {
            ...
            if (updatePlayHoverAnim && GetVehicle() == null)
            {
                if (IsAlive())
                {
        ...
        public bool SetHover(bool enable, bool updateAnimTier = true)
        {
            ...
            if (enable)
            {
                ...
                if (hoverHeight != 0 && GetPositionZ() - GetFloorZ() < hoverHeight)
                    UpdateHeight(Math.Max(GetFloorZ() + hoverHeight, GetPositionZ()));
            }
            else
            {

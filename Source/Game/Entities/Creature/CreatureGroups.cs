...
namespace Game.Entities
{
	...
	{
		private static Dictionary<ulong, FormationInfo> _creatureGroupMap = new();
	...
	public class CreatureGroup
	{
		...
		private ulong _leaderSpawnId;
		private Dictionary<Creature, FormationInfo> _members = new();
		...
		public bool CanLeaderStartMoving()
		{
			foreach (var pair in _members)
				if (pair.Key != _leader &&
				    pair.Key.IsAlive())
					if (pair.Key.IsEngaged() ||
					    pair.Key.IsReturningHome())
						return false;

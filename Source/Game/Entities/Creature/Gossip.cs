...
namespace Game.Misc
{
	public class GossipMenu
	{
		...
		private SortedDictionary<uint, GossipMenuItem> _menuItems = new();
	...
	{
		private GossipMenu _gossipMenu = new();
		private InteractionData _interactionData = new();
		private QuestMenu _questMenu = new();
	...
	{
		private List<QuestMenuItem> _questMenuItems = new();

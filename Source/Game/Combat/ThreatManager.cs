...
namespace Game.Combat
{
	public class ThreatManager
	{
		...
		private Dictionary<ObjectGuid, ThreatReference> _myThreatListEntries = new();
		private List<ThreatReference> _needsAIUpdate = new();
		...
		private List<ThreatReference> _sortedThreatList = new();

		private Dictionary<ObjectGuid, ThreatReference> _threatenedByMe = new(); // these refs are entries for myself on other units' threat lists

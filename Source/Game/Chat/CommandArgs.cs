    ...
    internal class CommandArgs
    {
                            ...
                            case nameof(AchievementRecord):
                                {
                                    ...
                                    if (!result.IsSuccessful() ||
                                        (val = CliDB.AchievementStorage.LookupByKey((uint)tempVal)) != null)
                                        return result;
                            ...
                            case nameof(CurrencyTypesRecord):
                                {
                                    ...
                                    if (!result.IsSuccessful() ||
                                        (val = CliDB.CurrencyTypesStorage.LookupByKey((uint)tempVal)) != null)
                                        return result;
                            ...
                            case nameof(GameTele):
                                {
                                    ...
                                    if (!result.IsSuccessful() ||
                                        (val = Global.ObjectMgr.GetGameTele(tempVal)) != null)
                                        return result;
                            ...
                            case nameof(ItemTemplate):
                                {
                                    ...
                                    if (!result.IsSuccessful() ||
                                        (val = Global.ObjectMgr.GetItemTemplate(tempVal)) != null)
                                        return result;
                            ...
                            case nameof(SpellInfo):
                                {
                                    ...
                                    if (!result.IsSuccessful() ||
                                        (val = Global.SpellMgr.GetSpellInfo(tempVal, Difficulty.None)) != null)
                                        return result;
                            ...
                            case nameof(Quest):
                                {
                                    ...
                                    if (!result.IsSuccessful() ||
                                        (val = Global.ObjectMgr.GetQuestTemplate(tempVal)) != null)
                                        return result;
        ...
        public static ChatCommandResult TryConsumeVariant(out dynamic val, Type[] types, CommandHandler handler, string args)
        {
            ...
            if (result.HasErrorMessage() &&
                (result.GetErrorMessage().IndexOf('\n') != -1))

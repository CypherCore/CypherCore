...
namespace Game.Chat
{
	...
	{
		private static ChannelManager allianceChannelMgr = new(Team.Alliance);
		private static ChannelManager hordeChannelMgr = new(Team.Horde);
		private Dictionary<ObjectGuid, Channel> _channels = new();

		private Dictionary<string, Channel> _customChannels = new();

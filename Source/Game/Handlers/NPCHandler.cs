...
namespace Game
{
	public partial class WorldSession
	{
		...
		private void HandleSetPetSlot(SetPetSlot setPetSlot)
		{
			...
			else if (SharedConst.IsStabledPetSlot(srcPetSlot) &&
			         SharedConst.IsStabledPetSlot(dstPetSlot))
			{
			...
			else if (SharedConst.IsActivePetSlot(srcPetSlot) &&
			         SharedConst.IsStabledPetSlot(dstPetSlot))
			{

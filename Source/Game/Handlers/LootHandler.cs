    ...
    public partial class WorldSession
    {
        ...
        public void DoLootRelease(Loot loot)
        {
            ...
            if (lguid.IsGameObject())
            {
                ...
                if (loot.IsLooted() ||
                    go.GetGoType() == GameObjectTypes.FishingNode ||
                    go.GetGoType() == GameObjectTypes.FishingHole)
                {
                    ...
                    else if (go.GetGoType() != GameObjectTypes.GatheringNode &&
                             go.IsFullyLooted())
                    {
                        go.SetLootState(LootState.JustDeactivated);
                    }
            ...
            else if (lguid.IsCorpse()) // ONLY remove insignia at BG
            {
                ...
                if (!corpse ||
                    !corpse.IsWithinDistInMap(player, SharedConst.InteractionDistance))
                    return;
        ...
        private void HandleLootMasterGive(MasterLootItem masterLootItem)
        {
            ...
            if (GetPlayer().GetGroup() == null ||
                GetPlayer().GetGroup().GetLooterGuid() != GetPlayer().GetGUID())
            {

...
namespace Game.Scripting
{
	...
	{
		private List<IScriptObject> _blankList = new();

		// creature entry + chain ID
		private MultiMap<Tuple<uint, ushort>, SplineChainLink> _mSplineChainsMap = new(); // spline chains

		private Dictionary<Type, List<IScriptObject>> _scriptByType = new();
		private uint _scriptCount;
		private Dictionary<Type, ScriptRegistry> _scriptStorage = new();

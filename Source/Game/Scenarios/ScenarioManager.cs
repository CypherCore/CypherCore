...
namespace Game.Scenarios
{
	...
	{
		private Dictionary<uint, ScenarioData> _scenarioData = new();
		private Dictionary<Tuple<uint, byte>, ScenarioDBData> _scenarioDBData = new();
		private MultiMap<uint, ScenarioPOI> _scenarioPOIStore = new();

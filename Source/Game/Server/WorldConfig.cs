...
namespace Game
{
	...
	{
		private static Dictionary<WorldCfg, object> Values = new();
		...
		public static void Load(bool reload = false)
		{
			...
			if ((int)Values[WorldCfg.Compression] < 1 ||
			    (int)Values[WorldCfg.Compression] > 9)
			{
			...
			if ((int)Values[WorldCfg.AuctionSearchDelay] < 100 ||
			    (int)Values[WorldCfg.AuctionSearchDelay] > 10000)
			{
			...
			if ((int)Values[WorldCfg.AuctionTaintedSearchDelay] < 100 ||
			    (int)Values[WorldCfg.AuctionTaintedSearchDelay] > 10000)
			{
			...
			if ((bool)Values[WorldCfg.BasemapLoadGrids] &&
			    (bool)Values[WorldCfg.GridUnload])
			{
			...
			if ((int)Values[WorldCfg.MinPlayerName] < 1 ||
			    (int)Values[WorldCfg.MinPlayerName] > 12)
			{
			...
			if ((int)Values[WorldCfg.MinCharterName] < 1 ||
			    (int)Values[WorldCfg.MinCharterName] > 24)
			{
			...
			if ((int)Values[WorldCfg.MinPetName] < 1 ||
			    (int)Values[WorldCfg.MinPetName] > 12)
			{
			...
			if ((int)Values[WorldCfg.CharactersPerRealm] < 1 ||
			    (int)Values[WorldCfg.CharactersPerRealm] > 200)
			{
			...
			if ((int)Values[WorldCfg.CharacterCreatingEvokersPerRealm] < 0 ||
			    (int)Values[WorldCfg.CharacterCreatingEvokersPerRealm] > 10)
			{
			...
			if ((int)Values[WorldCfg.SkipCinematics] < 0 ||
			    (int)Values[WorldCfg.SkipCinematics] > 2)
			{
			...
			if ((int)Values[WorldCfg.MaxOverspeedPings] != 0 &&
			    (int)Values[WorldCfg.MaxOverspeedPings] < 2)
			{
			...
			if ((int)Values[WorldCfg.NoGrayAggroAbove] > 0 &&
			    (int)Values[WorldCfg.NoGrayAggroAbove] < (int)Values[WorldCfg.NoGrayAggroBelow])
			{
			...
			if ((int)Values[WorldCfg.PacketSpoofBanmode] == 1 ||
			    (int)Values[WorldCfg.PacketSpoofBanmode] > 2)

...
namespace Game.BattleGrounds.Zones.EyeOfTheStorm
{
    internal class BgEyeofStorm : Battleground
    {
        ...
        private void UpdatePointStatuses()
        {
            for (byte point = 0; point < EotSPoints.PointsMax; ++point)
            {
                ...
                {
                    UpdateWorldState(EotSMisc._PointsIconStruct[point].WorldStateAllianceStatusBarIcon, captureStatus == BattlegroundPointCaptureStatus.AllianceControlled ? 2 : captureStatus == BattlegroundPointCaptureStatus.AllianceCapturing ? 1 : 0);
                    UpdateWorldState(EotSMisc._PointsIconStruct[point].WorldStateHordeStatusBarIcon, captureStatus == BattlegroundPointCaptureStatus.HordeControlled ? 2 : captureStatus == BattlegroundPointCaptureStatus.HordeCapturing ? 1 : 0);
        ...
        {
            // doors
            if (!AddObject(EotSObjectTypes.DOOR_A, EotSObjectIds.ADoorEyEntry, 2527.59716796875f, 1596.90625f, 1238.4544677734375f, 3.159139871597290039f, 0.173641681671142578f, 0.001514434814453125f, -0.98476982116699218f, 0.008638577535748481f, BattlegroundConst.RespawnImmediately) ||
                !AddObject(EotSObjectTypes.DOOR_H, EotSObjectIds.HDoorEyEntry, 1803.2066650390625f, 1539.486083984375f, 1238.4544677734375f, 3.13898324966430664f, 0.173647880554199218f, 0.0f, 0.984807014465332031f, 0.001244877814315259f, BattlegroundConst.RespawnImmediately)
                // banners (alliance)
                ||
    ...
    {
        public const int DOOR_A = 0;
        public const int DOOR_H = 1;

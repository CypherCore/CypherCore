...
namespace Game.BattleGrounds
{
	public class Battleground : ZoneScript, IDisposable
	{
		...
		{
			_HonorMode = is_holiday ? BGHonorMode.Holiday : BGHonorMode.Normal;
		}
		...
		public bool _BuffChange;
		private bool _IsRandom;

		public BGHonorMode _HonorMode;
		public uint[] _TeamScores = new uint[SharedConst.PvpTeamsCount];
		...
		// Player lists
		private List<ObjectGuid> _ResurrectQueue = new(); // Player GUID
		private List<ObjectGuid> _OfflineQueue = new();   // Player GUID
		...
		private uint[] _ArenaTeamIds = new uint[SharedConst.PvpTeamsCount];

		private uint[] _ArenaTeamMMR = new uint[SharedConst.PvpTeamsCount];
		...
		private List<BattlegroundPlayerPosition> _playerPositions = new();

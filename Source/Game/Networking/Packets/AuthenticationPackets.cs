...
namespace Game.Networking.Packets
{
	...
	{
		private static byte[] expandedPrivateKey;

		private static byte[] EnableEncryptionSeed =
		{
			0x90, 0x9C, 0xD0, 0x50, 0x5A, 0x2C, 0x14, 0xDD, 0x5C, 0x2C, 0xC0, 0x64, 0x14, 0xF3, 0xFE, 0xC9
		};

		private static byte[] EnableEncryptionContext =
		{
			0xA7, 0x1F, 0xB6, 0x9B, 0xC9, 0x7C, 0xDD, 0x96, 0xE9, 0xBB, 0xB8, 0x21, 0x39, 0x8D, 0x5A, 0xD4
		};

		private static byte[] EnterEncryptedModePrivateKey =
		{

    ...
    public sealed class ObjectManager : Singleton<ObjectManager>
    {
        ...
        public void LoadCreatures()
        {
            ...
            do
            {
                ...
                if (data.unit_flags2.HasValue)
                {
                    ...
                    if ((data.unit_flags2.Value & (uint)UnitFlags2.FeignDeath) != 0 && (!data.unit_flags.HasValue || (data.unit_flags.Value & (uint)(UnitFlags.ImmuneToPc | UnitFlags.ImmuneToNpc)) == 0) && (cInfo.UnitFlags & (UnitFlags.ImmuneToPc | UnitFlags.ImmuneToNpc)) == 0)
                    {
                ...
                if (data.unit_flags3.HasValue)
                {
                    ...
                    if ((data.unit_flags3.Value & (uint)UnitFlags3.FakeDead) != 0 && (!data.unit_flags.HasValue || (data.unit_flags.Value & (uint)(UnitFlags.ImmuneToPc | UnitFlags.ImmuneToNpc)) == 0) && (cInfo.UnitFlags & (UnitFlags.ImmuneToPc | UnitFlags.ImmuneToNpc)) == 0)
                    {
        ...
        public void LoadAreaTriggerTeleports()
        {
            ...
            do
            {
                ...
                _areaTriggerStorage[triggerId] = portLoc;
        ...
        public WorldSafeLocsEntry GetAreaTrigger(uint trigger)
        {
        ...
        public WorldSafeLocsEntry GetGoBackTrigger(uint Map)
        {
            uint? parentId = null;
            ...
            {
                if (pair.Value.Loc.GetMapId() == entrance_map)
                {
        ...
        public WorldSafeLocsEntry GetMapEntranceTrigger(uint Map)
        {
            foreach (var pair in _areaTriggerStorage)
            {
                if (pair.Value.Loc.GetMapId() == Map)
                {
                    AreaTriggerRecord atEntry = CliDB.AreaTriggerStorage.LookupByKey(pair.Key);
                    if (atEntry != null)
                        return pair.Value;
        ...
        Dictionary<uint, WorldSafeLocsEntry> _areaTriggerStorage = new();

...
namespace Game.Collision
{
	...
	{
		private Dictionary<uint, uint> iLoadedSpawns = new();

		private Dictionary<uint, bool> iLoadedTiles = new();

		private uint iMapID;
		private uint iNTreeValues;
		private Dictionary<uint, uint> iSpawnIndices = new();
		private BIH iTree = new();

...
namespace Game.Collision
{
	...
	public class VMapManager : Singleton<VMapManager>
	{
		...
		private Dictionary<uint, StaticMapTree> iInstanceMapTrees = new();

		private Dictionary<string, ManagedModel> iLoadedModelFiles = new();
		private Dictionary<uint, uint> iParentMapData = new();

		private object LoadedModelFilesLock = new();

...
namespace Game.Collision
{
    ...
    public class WModelAreaCallback : WorkerCallback
    {
        ...
        private readonly List<GroupModel> prims;
        public float zDist;
    ...
    {
        public bool hit;
        private readonly List<GroupModel> models;
    ...
    {
        public bool hit;
        private readonly List<MeshTriangle> triangles;
    ...
    {
        private readonly ModelIgnoreFlags flags;
        private bool hit;

        private readonly ModelInstance[] prims;

...
namespace Game.Movement
{
	...
	{
		private static uint FORMATION_MOVEMENT_INTERVAL = 1200; // sniffed (3 batch update cycles)
		...
		private TimeTracker _nextMoveTimer = new();
		private uint _point1;
		private uint _point2;
		...
		public override bool DoUpdate(Creature owner, uint diff)
		{
				    ...
				    target.IsCreature())
				{
					...
					if (formation != null)
					{
						...
						if (leader != null)
						{
							...
							if (currentWaypoint == _point1 ||
							    currentWaypoint == _point2)
			...
			if (owner.HasUnitState(UnitState.FollowFormationMove) &&

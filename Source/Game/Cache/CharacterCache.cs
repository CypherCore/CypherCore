...
namespace Game.Cache
{
	...
	{
		private Dictionary<string, CharacterCacheEntry> _characterCacheByNameStore = new();
		private Dictionary<ObjectGuid, CharacterCacheEntry> _characterCacheStore = new();

...
namespace Game.AI
{
    public interface IUnitAI
    {
        ...
        void DamageDealt(Unit victim, ref uint damage, DamageEffectType damageType);
        void DamageTaken(Unit attacker, ref uint damage, DamageEffectType damageType, SpellInfo spellInfo = null);
        ...
        void HealDone(Unit to, uint addhealth);
        void HealReceived(Unit by, uint addhealth);
        void InitializeAI();

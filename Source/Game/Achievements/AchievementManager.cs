...
namespace Game.Achievements
{
	...
	public class AchievementGlobalMgr : Singleton<AchievementGlobalMgr>
	{
		...
		private Dictionary<uint, AchievementReward> _achievementRewards = new();
		private Dictionary<uint, uint> _achievementScripts = new();

		// store realm first achievements
		private Dictionary<uint /*achievementId*/, DateTime /*completionTime*/> _allCompletedAchievements = new();

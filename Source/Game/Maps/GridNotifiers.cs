...
namespace Game.Maps
{
    ...
    {
        private readonly ICollection<WorldObject> i_objects;
    ...
    {
        private readonly Creature i_creature;
    ...
    public class DelayedUnitRelocation : Notifier
    {
        ...
        private readonly float i_radius;
    ...
    {
        private readonly ServerPacket Data;
    ...
    {
        private readonly float i_distSq;
        private readonly T i_packetSender;
        private readonly PhaseShift i_phaseShift;
        private readonly WorldObject i_source;
        private readonly bool required3dDist;
        private readonly Player skipped_receiver;
    ...
    public class MessageDistDelivererToHostile<T> : Notifier where T : IDoWork<Player>
    {
        ...
        private readonly T i_packetSender;
        private readonly PhaseShift i_phaseShift;
        private readonly Unit i_source;
    ...
    {
        private readonly uint i_timeDiff;
    ...
    {
        private readonly IDoWork<Creature> Do;
        private readonly PhaseShift i_phaseShift;
    ...
    {
        private readonly IDoWork<WorldObject> i_do;
    ...
    {
        private readonly List<ObjectGuid> plr_list = new();

        private readonly Dictionary<Player, UpdateData> updateData;
    ...
    public class PlayerDistWorker : Notifier
    {
        ...
        private readonly float i_dist;
        private readonly WorldObject i_searcher;
    ...
    {
        private readonly Unit i_enemy;

        private readonly Unit i_funit;
    ...
    public class WorldObjectListSearcher : Notifier
    {
        private readonly ICheck<WorldObject> i_check;
        private readonly GridMapTypeMask i_mapTypeMask;
        private readonly List<WorldObject> i_objects;
        private readonly PhaseShift i_phaseShift;
    ...
    {
        private readonly ICheck<GameObject> i_check;
        private readonly List<GameObject> i_objects;
        private readonly PhaseShift i_phaseShift;
    ...
    {
        private readonly ICheck<Unit> i_check;
        private readonly List<Unit> i_objects;
        private readonly PhaseShift i_phaseShift;
    ...
    {
        private readonly uint i_entry;
        private readonly bool i_excludeSelf;

        private readonly Unit i_obj;
        private readonly byte i_pct;
        private readonly float i_range;
    ...
    {
        private readonly Unit i_funit;
        private readonly bool i_incOwnRadius;
        private readonly bool i_incTargetRadius;
    ...
    {
        private readonly bool i_check3D;
    ...
    internal class NearestAssistCreatureInCreatureRangeCheck : ICheck<Creature>
    {
        ...
        private readonly Creature i_obj;
        private float i_range;
    ...
    internal class GameObjectInRangeCheck : ICheck<GameObject>
    {
        ...
        private readonly float x, y, z, range;
    ...
    public class AnyDeadUnitObjectInRangeCheck<T> : ICheck<T> where T : WorldObject
    {
        ...
        private readonly WorldObject i_searchObj;
    ...
    {
        private readonly WorldObjectSpellTargetCheck i_check;

...
namespace Game.SupportSystem
{
	public class SupportManager : Singleton<SupportManager>
	{
		...
		private Dictionary<uint, BugTicket> _bugTicketList = new();
		private bool _complaintSystemStatus;
		private Dictionary<uint, ComplaintTicket> _complaintTicketList = new();
		...
		private Dictionary<uint, SuggestionTicket> _suggestionTicketList = new();

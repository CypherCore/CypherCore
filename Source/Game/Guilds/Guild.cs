...
namespace Game.Guilds
{
    public class Guild
    {
        ...
        public bool Create(Player pLeader, string name)
        {
            ...
            var ret = AddMember(trans, m_leaderGuid, GuildDefaultRanks.Master);                  // Add guildmaster
        ...
        public bool SetName(string name)
        {
            ...
            var guildNameChanged = new GuildNameChanged();
        ...
        public void HandleRoster(WorldSession session = null)
        {
            ...
            {
                var memberData = new GuildRosterMemberData();
        ...
        public void SendGuildRankInfo(WorldSession session)
        {
            ...
            for (byte i = 0; i < _GetRanksSize(); i++)
            {
                var rankInfo = GetRankInfo(i);
                if (rankInfo == null)
                    continue;

                var rankData = new GuildRankData();
        ...
        public void HandleSetBankTabInfo(WorldSession session, byte tabId, string name, string icon)
        {
            ...
            var packet = new GuildEventTabModified();
            packet.Tab = tabId;
            packet.Name = name;
            packet.Icon = icon;
        ...
        public void HandleSetMemberNote(WorldSession session, string note, ObjectGuid guid, bool isPublic)
        {
            ...
            if (member != null)
            {
                ...
                var updateNote = new GuildMemberUpdateNote();
        ...
        public void HandleSetRankInfo(WorldSession session, uint rankId, string name, GuildRankRights rights, uint moneyPerDay, GuildBankRightsAndSlots[] rightsAndSlots)
        {
            ...
            if (rankInfo != null)
            {
                ...
                var packet = new GuildEventRankChanged();
        ...
        public void HandleUpdateMemberRank(WorldSession session, ObjectGuid guid, bool demote)
        {
            ...
            else if ((member = GetMember(guid)) != null)
            {
                ...
                var newRankId = (uint)(member.GetRankId() + (demote ? 1 : -1));
        ...
        public void HandleGuildPartyRequest(WorldSession session)
        {
            ...
            var partyStateResponse = new GuildPartyState();
        ...
        {
            var updatePacket = new GuildChallengeUpdate();
        ...
        public void SendEventLog(WorldSession session)
        {
            ...
            var packet = new GuildEventLogQueryResults();
            foreach (var logEntry in logs)
            {
                var eventLog = (EventLogEntry)logEntry;
        ...
        public void SendNewsUpdate(WorldSession session)
        {
            ...
            var packet = new GuildNewsPkt();
            foreach (var logEntry in logs)
            {
                var eventLog = (NewsLogEntry)logEntry;
                eventLog.WritePacket(packet);
            }
        ...
        public void SendBankLog(WorldSession session, byte tabId)
        {
            ...
            if (tabId < _GetPurchasedTabsSize() || tabId == GuildConst.MaxBankTabs)
            {
                ...
                var packet = new GuildBankLogQueryResults();
                packet.Tab = tabId;
                ...
                foreach (var logEntry in logs)
                {
                    var bankEventLog = (BankEventLogEntry)logEntry;
        ...
        public void SendPermissions(WorldSession session)
        {
            ...
            var queryResult = new GuildPermissionsQueryResults();
        ...
        public void SendMoneyInfo(WorldSession session)
        {
            ...
            var packet = new GuildBankRemainingWithdrawMoney();
        ...
        public void SendLoginInfo(WorldSession session)
        {
            ...
            {
                var renameFlag = new GuildFlaggedForRename();
        ...
        public void SendEventAwayChanged(ObjectGuid memberGuid, bool afk, bool dnd)
        {
            ...
            var statusChange = new GuildEventStatusChange();
        ...
        {
            var eventPacket = new GuildEventBankMoneyChanged();
        ...
        {
            var eventPacket = new GuildEventMotd();
        ...
        {
            var eventPacket = new GuildEventNewLeader();
        ...
        {
            var eventPacket = new GuildEventPlayerLeft();
        ...
        private void SendEventPresenceChanged(WorldSession session, bool loggedOn, bool broadcast = false)
        {
            ...
            var eventPacket = new GuildEventPresenceChange();
        ...
        {
            var rankInfo = new RankInfo(m_id);
        ...
        public bool LoadMemberFromDB(SQLFields field)
        {
            ...
            var member = new Member(m_id, playerGuid, field.Read<byte>(2));
        ...
        {
            // tabId              rights                slots
            var rightsAndSlots = new GuildBankRightsAndSlots(field.Read<byte>(1), field.Read<sbyte>(3), field.Read<int>(4));
            // rankId
        ...
        {
            var packet = new CalendarCommunityInvite();
        ...
        public bool AddMember(SQLTransaction trans, ObjectGuid guid, byte rankId = GuildConst.RankNone)
        {
            ...
            var member = new Member(m_id, guid, rankId);
            var name = "";
            if (player != null)
            {
            ...
            var joinNotificationPacket = new GuildEventPlayerJoined();
        ...
        public void SwapItems(Player player, byte tabId, byte slotId, byte destTabId, byte destSlotId, uint splitedAmount)
        {
            ...
            var from = new BankMoveItemData(this, player, tabId, slotId);
            var to = new BankMoveItemData(this, player, destTabId, destSlotId);
        ...
        public void SwapItemsWithInventory(Player player, bool toChar, byte tabId, byte slotId, byte playerBag, byte playerSlotId, uint splitedAmount)
        {
            ...
            var bankData = new BankMoveItemData(this, player, tabId, slotId);
            var charData = new PlayerMoveItemData(this, player, playerBag, playerSlotId);
            if (toChar)
        ...
        public void SetBankTabText(byte tabId, string text)
        {
            ...
            if (pTab != null)
            {
                ...
                var eventPacket = new GuildEventTabTextChanged();
        ...
        // Private methods
        private void _CreateLogHolders()
        {
        ...
        private void _UpdateAccountsNumber()
        {
            ...
            var accountsIdSet = new List<uint>();
            foreach (var member in m_members.Values)
        ...
        private void _SetRankBankMoneyPerDay(uint rankId, uint moneyPerDay)
        {
            var rankInfo = GetRankInfo(rankId);
            if (rankInfo != null)
        ...
        private void _SetRankBankTabRightsAndSlots(uint rankId, GuildBankRightsAndSlots rightsAndSlots, bool saveToDB = true)
        {
        ...
        private string _GetRankName(byte rankId)
        {
            var rankInfo = GetRankInfo(rankId);
            if (rankInfo != null)
        ...
        private GuildRankRights _GetRankRights(byte rankId)
        {
            var rankInfo = GetRankInfo(rankId);
            if (rankInfo != null)
        ...
        private uint _GetRankBankMoneyPerDay(byte rankId)
        {
            var rankInfo = GetRankInfo(rankId);
            if (rankInfo != null)
        ...
        private int _GetRankBankTabSlotsPerDay(byte rankId, byte tabId)
        {
            if (tabId < _GetPurchasedTabsSize())
            {
                var rankInfo = GetRankInfo(rankId);
        ...
        private GuildBankRights _GetRankBankTabRights(byte rankId, byte tabId)
        {
            var rankInfo = GetRankInfo(rankId);
            if (rankInfo != null)
        ...
        private bool _DoItemsMove(MoveItemData pSrc, MoveItemData pDest, bool sendError, uint splitedAmount = 0)
        {
        ...
        private void _SendBankContentUpdate(byte tabId, List<byte> slots)
        {
            ...
            if (tab != null)
            {
                var packet = new GuildBankQueryResults();
                ...
                foreach (var slot in slots)
                {
                    ...
                    {
                        byte i = 0;
                        foreach (var gemData in tabItem.m_itemData.Gems)
                        {
                            if (gemData.ItemId != 0)
                            {
        ...
        private void SendGuildRanksUpdate(ObjectGuid setterGuid, ObjectGuid targetGuid, uint rank)
        {
            var member = GetMember(targetGuid);
            Cypher.Assert(member != null);

            var rankChange = new GuildSendRankChange();
        ...
        {
            var news = new NewsLogEntry(m_id, m_newsLog.GetNextGUID(), type, guid, flags, value);

            var trans = new SQLTransaction();
            m_newsLog.AddEvent(trans, news);
            DB.Characters.CommitTransaction(trans);

            var newsPacket = new GuildNewsPkt();
        ...
        private byte _GetRanksSize() { return (byte)m_ranks.Count; }

        private RankInfo GetRankInfo(uint rankId) { return rankId < _GetRanksSize() ? m_ranks[(int)rankId] : null; }
        ...
        private byte _GetLowestRankId() { return (byte)(m_ranks.Count - 1); }

        private byte _GetPurchasedTabsSize() { return (byte)m_bankTabs.Count; }

        private BankTab GetBankTab(byte tabId) { return tabId < m_bankTabs.Count ? m_bankTabs[tabId] : null; }
        ...
        {
            var resultPacket = new GuildCommandResult();
        ...
        {
            var saveResponse = new PlayerSaveGuildEmblem();
        ...
        private List<RankInfo> m_ranks = new List<RankInfo>();
        private Dictionary<ObjectGuid, Member> m_members = new Dictionary<ObjectGuid, Member>();
        private List<BankTab> m_bankTabs = new List<BankTab>();

        // These are actually ordered lists. The first element is the oldest entry.
        private LogHolder m_eventLog;
        private LogHolder[] m_bankEventLog = new LogHolder[GuildConst.MaxBankTabs + 1];
        private LogHolder m_newsLog;
        private GuildAchievementMgr m_achievementSys;
        #endregion
        ...
        public class Member
        {
            ...
            private Player FindConnectedPlayer() { return Global.ObjAccessor.FindConnectedPlayer(m_guid); }
            ...
            private byte m_rankId;
            private string m_publicNote = "";
            private string m_officerNote = "";

            private List<uint> m_trackedCriteriaIds = new List<uint>();

            private uint[] m_bankWithdraw = new uint[GuildConst.MaxBankTabs];
        ...
        public class EventLogEntry : LogEntry
        {
            ...
            public void WritePacket(GuildEventLogQueryResults packet)
            {
                ...
                var eventEntry = new GuildEventEntry();
            ...
            private GuildEventLogTypes m_eventType;
            private ulong m_playerGuid1;
            private ulong m_playerGuid2;
            private byte m_newRank;
        }
        ...
        public class BankEventLogEntry : LogEntry
        {
            ...
            public void WritePacket(GuildBankLogQueryResults packet)
            {
                ...
                var hasItem = m_eventType == GuildBankEventLogTypes.DepositItem || m_eventType == GuildBankEventLogTypes.WithdrawItem ||
                ...
                var bankLogEntry = new GuildBankLogEntry();
            ...
            private GuildBankEventLogTypes m_eventType;
            private byte m_bankTabId;
            private ulong m_playerGuid;
            private ulong m_itemOrMoney;
            private ushort m_itemStackCount;
            private byte m_destTabId;
        }
        ...
        public class NewsLogEntry : LogEntry
        {
            ...
            {
                var newsEvent = new GuildNewsEvent();
        ...
        public class RankInfo
        {
            ...
            private GuildBankRightsAndSlots[] m_bankTabRightsAndSlots = new GuildBankRightsAndSlots[GuildConst.MaxBankTabs];
        }
        ...
        public class BankTab
        {
            ...
            public bool LoadItemFromDB(SQLFields field)
            {
                ...
                var pItem = Bag.NewItemOrBag(proto);
            ...
            {
                var textQuery = new GuildBankTextQueryResult();
            ...
            private ulong m_guildId;
            private byte m_tabId;
            private Item[] m_items = new Item[GuildConst.MaxBankSlots];
            private string m_name;
        ...
        public class BankMoveItemData : MoveItemData
        {
            ...
            private bool _ReserveSpace(byte slotId, Item pItem, Item pItemDest, ref uint count)
            {
                ...
                // Reserve space
                var pos = new ItemPosCount(slotId, requiredSpace);

...
namespace Game
{
	...
	{
		private List<QuestPool> _dailyPools = new();
		private List<QuestPool> _monthlyPools = new();
		private Dictionary<uint, QuestPool> _poolLookup = new(); // questId -> pool
		private List<QuestPool> _weeklyPools = new();

	...
	private void HandleDamage(uint UnnamedParameter)
	{
		...
		if (pet != null)
		{
			...
			if (owner != null)
			{
				...
				var CostModifier = Global.SpellMgr.GetSpellInfo(HunterSpells.SPELL_HUNTER_BASIC_ATTACK_COST_MODIFIER, Difficulty.None);
				var SpikedCollar = Global.SpellMgr.GetSpellInfo(HunterSpells.SPELL_HUNTER_SPIKED_COLLAR, Difficulty.None);

...
public class spell_monk_gift_of_the_ox_aura : ScriptObjectAutoAdd, IPlayerOnTakeDamage
{
	...
	public List<uint> spellsToCast = new List<uint>() { (uint)MonkSpells.SPELL_MONK_GIFT_OF_THE_OX_AT_RIGHT, (uint)MonkSpells.SPELL_MONK_GIFT_OF_THE_OX_AT_LEFT };
	...
	public void OnPlayerTakeDamage(Player victim, uint damage, SpellSchoolMask UnnamedParameter)
	{
		...
		uint spellToCast = spellsToCast[RandomHelper.IRand(0, (spellsToCast.Count - 1))];

...
using Game.Spells;
using static Game.Networking.Packets.MonsterSplineUnknown901;
...
namespace Scripts.Spells.Warrior
{
                                                           ...
                                                           
    {
        ...
        public static Dictionary<Player, int> RageSpent = new Dictionary<Player, int>();
        ...
        public void OnSpellCast(Player player, Spell spell, bool UnnamedParameter)
        {
            ...
            Aura anger = player.GetAura(WarriorSpells.ANGER_MANAGEMENT);

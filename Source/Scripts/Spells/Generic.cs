...
namespace Scripts.Spells.Generic
{
	...
	internal class spell_gen_battleground_mercenary_shapeshift : AuraScript, IHasAuraEffects
	{
		...
		private static Dictionary<Race, Race[]> RaceInfo = new()
		                                                   {
			                                                   {
				                                                   Race.Human, new[]
				                                                               {
		...
		private static Dictionary<Race, uint[]> RaceDisplayIds = new()
		                                                         {
			                                                         {
				                                                         Race.Human, new uint[]
				                                                                     {
		...
		private static List<uint> RacialSkills = new();
		public List<IAuraEffectHandler> Effects { get; } = new();
   ...
   66477 - Bountiful Feast */
	...
	{
		private static uint[] AncestralCallBuffs =
		{

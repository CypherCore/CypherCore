...
namespace Scripts.EasternKingdoms.Karazhan.ShadeOfAran
{
	...
	{
		private static uint[] AtieshStaves =
		{
		...
		private ObjectGuid[] FlameWreathTarget = new ObjectGuid[3];

		private uint FlameWreathTimer;
		private uint FrostCooldown;
		private float[] FWTargPosX = new float[3];
		private float[] FWTargPosY = new float[3];

...
namespace Scripts.Argus.AntorusTheBurningThrone.GarothiWorldbreaker
{
	...
	internal class boss_garothi_worldbreaker : BossAI
	{
		...
		private byte[] _apocalypseDriveHealthLimit = new byte[MiscConst.MaxApocalypseDriveCount];
		...
		private List<ObjectGuid> _surgingFelDummyGuids = new();
	...
	internal class VictimCheck : ICheck<WorldObject>
	{
		...
		private bool _keepTank; // true = remove all nontank targets | false = remove current tank

...
namespace Framework.Constants
{
    public enum ClientOpcodes : uint
    {
        ...
        AdventureJournalStartQuest = 0x3341,
        AdventureMapPoiQuery = 0x3248,
        ...
        AzeriteEmpoweredItemSelectPower = 0x335f,
        AzeriteEmpoweredItemViewed = 0x334b,
        AzeriteEssenceActivateEssence = 0x3361,
        AzeriteEssenceUnlockMilestone = 0x3360,
        BankerActivate = 0x34b3,
        BattlefieldLeave = 0x3173,
        BattlefieldList = 0x317e,
        BattlefieldPort = 0x3527,
        BattlemasterHello = 0x32b2,
        ...
        BattlePayRequestCurrentVasTransferQueues = 0x370f,
        BattlePayRequestPriceInfo = 0x370e,
        BattlePayRequestVasCharacterQueueTime = 0x3710,
        BattlePayStartPurchase = 0x36f8,
        BattlePayStartVasPurchase = 0x36f9,
        BattlePayTrialBoostCharacter = 0x36c8,
        BattlePayValidateBnetVasTransfer = 0x3711,
        ...
        CancelCast = 0x32a0,
        CancelChannelling = 0x326c,
        CancelGrowthAura = 0x3271,
        CancelMasterLootRoll = 0x3214,
        CancelModSpeedNoControlAuras = 0x31ac,
        CancelMountAura = 0x3282,
        CancelQueuedSpell = 0x317f,
        CancelTempEnchantment = 0x34f3,
        CancelTrade = 0x315c,
        CanDuel = 0x3664,
        CanRedeemWowTokenForBalance = 0x370d,
        CastSpell = 0x329d,
        ChallengeModeRequestLeaders = 0x3090,
        ChallengeModeRequestMapStats = 0x308f,
        ChangeBagSlotFlag = 0x3323,
        ChangeBankBagSlotFlag = 0x3324,
        ChangeMonumentAppearance = 0x3305,
        ...
        GameObjUse = 0x34ef,
        GarrisonAssignFollowerToBuilding = 0x32dc,
        GarrisonCancelConstruction = 0x32cd,
        GarrisonCheckUpgradeable = 0x331f,
        GarrisonCompleteMission = 0x3312,
        GarrisonGenerateRecruits = 0x32df,
        GarrisonGetBuildingLandmarks = 0x32ed,
        GarrisonGetMissionReward = 0x3345,
        GarrisonMissionBonusRoll = 0x3314,
        GarrisonPurchaseBuilding = 0x32c9,
        GarrisonRecruitFollower = 0x32e1,
        GarrisonRemoveFollower = 0x3309,
        GarrisonRemoveFollowerFromBuilding = 0x32dd,
        GarrisonRenameFollower = 0x32de,
        GarrisonRequestBlueprintAndSpecializationData = 0x32c8,
        GarrisonRequestClassSpecCategoryInfo = 0x32e6,
        GarrisonRequestLandingPageShipmentInfo = 0x32f0,
        GarrisonRequestShipmentInfo = 0x32ef,
        GarrisonResearchTalent = 0x32e2,
        GarrisonSetBuildingActive = 0x32ca,
        GarrisonSetFollowerFavorite = 0x32da,
        GarrisonSetFollowerInactive = 0x32d6,
        GarrisonSetRecruitmentPreferences = 0x32e0,
        GarrisonStartMission = 0x3311,
        GarrisonSwapBuildings = 0x32ce,
        GenerateRandomCharacterName = 0x35e8,
        GetAccountCharacterList = 0x36ba,
        GetChallengeModeRewards = 0x3685,
        GetGarrisonInfo = 0x32c3,
        GetItemPurchaseData = 0x3531,
        GetMirrorImageData = 0x3298,
        GetPvpOptionsEnabled = 0x35ef,
        GetRemainingGameTime = 0x36f2,
        GetTrophyList = 0x3302,
        ...
        OpenItem = 0x3321,
        OpenMissionNpc = 0x32e8,
        OpenShipmentNpc = 0x32ee,
        OpenTradeskillNpc = 0x32f9,
        OptOutOfLoot = 0x34f7,
        PartyInvite = 0x3603,
        ...
        RequestVehicleExit = 0x3238,
        RequestVehicleNextSeat = 0x323a,
        RequestVehiclePrevSeat = 0x3239,
        RequestVehicleSwitchSeat = 0x323b,
        RequestWorldQuestUpdate = 0x3348,
        ...
        RevertMonumentAppearance = 0x3306,
        RideVehicleInteract = 0x323c,
        SaveCufProfiles = 0x318b,
        SaveEquipmentSet = 0x350c,
        SaveGuildEmblem = 0x32a9,
        ...
        SetAdvancedCombatLogging = 0x32b6,
        SetAssistantLeader = 0x3651,
        SetBackpackAutosortDisabled = 0x3325,
        SetBankAutosortDisabled = 0x3326,
        ...
        SetInsertItemsLeftToRight = 0x3328,
        SetLfgBonusFactionId = 0x32a4,
        ...
        SetSelection = 0x352a,
        SetSheathed = 0x3489,
        SetSortBagsRightToLeft = 0x3327,
        SetTaxiBenchmarkMode = 0x34f4,
        SetTitle = 0x3281,
        SetTradeCurrency = 0x3160,
        SetTradeGold = 0x315f,
        SetTradeItem = 0x315d,
        SetUsingPartyGarrison = 0x32ea,
        SetWarMode = 0x32ae,
    ...
    public enum ServerOpcodes : uint
    {
        ...
        AdventureMapPoiQueryResponse = 0x2847,
        ...
        AreaPoiUpdate = 0x2854,
        AreaSpiritHealerTime = 0x278b,
        AreaTriggerDenied = 0x26a3,
        AreaTriggerNoCorpse = 0x275f,
        AreaTriggerPlayVisualEvent = 0x2640,
        AreaTriggerRePath = 0x263e,
        AreaTriggerReShape = 0x2643,
        ArenaCrowdControlSpells = 0x2651,
        ArenaMatchEnd = 0x28ac,
        ArenaMatchStart = 0x28ab,
        ArenaPrepOpponentSpecializations = 0x2668,
        ArtifactForgeOpened = 0x27ef,
        ArtifactRespecConfirm = 0x27f2,
        ArtifactTraitsRefunded = 0x27f3,
        ArtifactXpGain = 0x2837,
        AttackerStateUpdate = 0x27dc,
        AttackStart = 0x2670,
        AttackStop = 0x2671,
        AttackSwingError = 0x273d,
        AttackSwingLandedLog = 0x273e,
        AuctionClosedNotification = 0x2732,
        AuctionCommandResult = 0x272f,
        AuctionHelloResponse = 0x272d,
        AuctionListBidderItemsResult = 0x2736,
        AuctionListItemsResult = 0x2734,
        AuctionListOwnerItemsResult = 0x2735,
        AuctionListPendingSalesResult = 0x2737,
        AuctionOutbidNotification = 0x2731,
        AuctionOwnerBidNotification = 0x2733,
        AuctionReplicateResponse = 0x272e,
        AuctionWonNotification = 0x2730,
        ...
        AzeriteEmpoweredItemRespecOpen = 0x2841,
        AzeriteEssenceForgeClose = 0x2879,
        AzeriteEssenceForgeOpened = 0x2878,
        AzeriteEssenceSelectionResult = 0x2877,
        ...
        BattlegroundInit = 0x27aa,
        BattlegroundPlayerJoined = 0x2599,
        BattlegroundPlayerLeft = 0x259a,
        BattlegroundPlayerPositions = 0x2596,
        BattlegroundPoints = 0x27a9,
        BattlenetChallengeAbort = 0x27db,
        BattlenetChallengeStart = 0x27da,
        BattlenetNotification = 0x284f,
        BattlenetRealmListTicket = 0x2851,
        BattlenetResponse = 0x284e,
        BattlenetSetSessionState = 0x2850,
        BattlenetUpdateSessionKey = 0x286f,
        BattlePayAckFailed = 0x27d3,
        BattlePayBattlePetDelivered = 0x27c8,
        BattlePayBundlePriceUpdate = 0x2862,
        BattlePayConfirmPurchase = 0x27d2,
        BattlePayDeliveryEnded = 0x27c6,
        BattlePayDeliveryStarted = 0x27c5,
        BattlePayDistributionUpdate = 0x27c4,
        BattlePayGetDistributionListResponse = 0x27c2,
        BattlePayGetProductListResponse = 0x27c0,
        BattlePayGetPurchaseListResponse = 0x27c1,
        BattlePayMountDelivered = 0x27c7,
        BattlePayOpenCheckoutResult = 0x2868,
        BattlePayPurchaseUpdate = 0x27d1,
        BattlePayStartDistributionAssignToTargetResponse = 0x27cf,
        BattlePayStartPurchaseResponse = 0x27ce,
        BattlePaySubscriptionChanged = 0x2871,
        BattlePayToyDelivered = 0x27c9,
        BattlePayVasBnetTransferValidationResult = 0x2866,
        BattlePayVasBoostConsumed = 0x27c3,
        BattlePayVasCharacterList = 0x283a,
        BattlePayVasCharacterQueueStatus = 0x2864,
        BattlePayVasGuildFollowInfo = 0x29e7,
        BattlePayVasGuildMasterList = 0x29e6,
        BattlePayVasPurchaseComplete = 0x283d,
        BattlePayVasPurchaseList = 0x283e,
        BattlePayVasPurchaseStarted = 0x283c,
        BattlePayVasRealmList = 0x283b,
        ...
        BonusRollFailed = 0x287c,
        BossKillCredit = 0x27cd,
        BreakTarget = 0x266f,
        ...
        ChangePlayerDifficultyResult = 0x273f,
        ChannelList = 0x2bc3,
        ChannelNotify = 0x2bc0,
        ChannelNotifyJoined = 0x2bc1,
        ChannelNotifyLeft = 0x2bc2,
        CharacterClassTrialCreate = 0x280d,
        CharacterInventoryOverflowWarning = 0x2870,
        CharacterItemFixup = 0x285f,
        CharacterLoginFailed = 0x274e,
        CharacterObjectTestResponse = 0x27d9,
        CharacterRenameResult = 0x27b2,
        CharacterUpgradeComplete = 0x280c,
        CharacterUpgradeQueued = 0x280b,
        CharacterUpgradeSpellTierSet = 0x25f5,
        CharacterUpgradeStarted = 0x280a,
        CharacterUpgradeUnrevokeResult = 0x280e,
        CharCustomize = 0x2723,
        CharCustomizeFailed = 0x2722,
        CharFactionChangeResult = 0x27f7,
        Chat = 0x2bad,
        ...
        ClearTarget = 0x26e4,
        ClubFinderApplicantsList = 0x28b3,
        ClubFinderApplications = 0x28b4,
        ClubFinderApplicationsChanged = 0x28b5,
        ClubFinderClubsData = 0x28b6,
        ClubFinderClubsList = 0x28b2,
        CoinRemoved = 0x262d,
        CombatEventFailed = 0x2672,
        CommentatorMapInfo = 0x2750,
        CommentatorPlayerInfo = 0x2751,
        CommentatorStateChanged = 0x274f,
        ComplaintResult = 0x26db,
        CompleteShipmentResponse = 0x27eb,
        ConnectTo = 0x304d,
        ConquestFormulaConstants = 0x27d4,
        ConsoleWrite = 0x2654,
        ContactList = 0x27d7,
        ContributionCollectorState = 0x2867,
        ControlUpdate = 0x2667,
        CooldownCheat = 0x2784,
        CooldownEvent = 0x26ec,
        CorpseLocation = 0x266e,
        CorpseReclaimDelay = 0x2797,
        CorpseTransportQuery = 0x275b,
        CreateChar = 0x2748,
        CreateShipmentResponse = 0x27ea,
        CriteriaDeleted = 0x2727,
        CriteriaUpdate = 0x2721,
        CrossedInebriationThreshold = 0x26f5,
        CustomLoadScreen = 0x25e3,
        DailyQuestsReset = 0x2a80,
        DamageCalcLog = 0x2815,
        DbReply = 0x25a1,
        DeathReleaseLoc = 0x2710,
        DefenseMessage = 0x2bb6,
        DeleteChar = 0x2749,
        DestroyArenaUnit = 0x278d,
        DestructibleBuildingDamage = 0x273c,
        ...
        GameObjectMultiTransition = 0x287a,
        GameObjectPlaySpellVisual = 0x2c4b,
        GameObjectPlaySpellVisualKit = 0x2c4a,
        GameObjectResetState = 0x2766,
        GameObjectSetState = 0x284d,
        GameObjectUiAction = 0x2763,
        GameSpeedSet = 0x26b0,
        GameTimeSet = 0x2755,
        GameTimeUpdate = 0x2754,
        ...
        GarrisonLandingPageShipmentInfo = 0x27ed,
        ...
        GetAccountCharacterListResult = 0x27b0,
        GetDisplayedTrophyListResponse = 0x2928,
        GetGarrisonInfoResult = 0x28f0,
        GetShipmentsOfTypeResponse = 0x27ec,
        GetShipmentInfoResponse = 0x27e8,
        GetTrophyListResponse = 0x2811,
        GmPlayerInfo = 0x2783,
        ...
        IncomingSummonCompleted = 0x28ae,
        IncomingSummonPending = 0x28ad,
        InitializeFactions = 0x276e,
        InitialSetup = 0x2580,
        InitWorldStates = 0x2794,
        InspectResult = 0x2650,
        InstanceEncounterChangePriority = 0x27fd,
        InstanceEncounterDisengageUnit = 0x27fc,
        InstanceEncounterEnd = 0x2805,
        InstanceEncounterEngageUnit = 0x27fb,
        InstanceEncounterGainCombatResurrectionCharge = 0x2807,
        InstanceEncounterInCombatResurrection = 0x2806,
        InstanceEncounterObjectiveComplete = 0x2800,
        InstanceEncounterObjectiveStart = 0x27ff,
        InstanceEncounterObjectiveUpdate = 0x2804,
        InstanceEncounterPhaseShiftChanged = 0x2808,
        InstanceEncounterSetAllowingRelease = 0x2803,
        InstanceEncounterSetSuppressingRelease = 0x2802,
        InstanceEncounterStart = 0x2801,
        InstanceEncounterTimerStart = 0x27fe,
        InstanceGroupSizeChanged = 0x2740,
        InstanceInfo = 0x2653,
        InstanceReset = 0x26b5,
        InstanceResetFailed = 0x26b6,
        InstanceSaveCreated = 0x27ca,
        InvalidatePageText = 0x270c,
        InvalidatePlayer = 0x26da,
        InvalidPromotionCode = 0x279f,
        InventoryChangeFailure = 0x276c,
        IslandAzeriteXpGain = 0x27ac,
        IslandCompleted = 0x27ad,
        IslandOpenQueueNpc = 0x2842,
        IsQuestCompleteResponse = 0x2a83,
        ItemChanged = 0x272a,
        ItemCooldown = 0x2814,
        ItemEnchantTimeUpdate = 0x27a1,
        ItemExpirePurchaseRefund = 0x25b2,
        ItemPurchaseRefundResult = 0x25b0,
        ItemPushResult = 0x2639,
        ItemTimeUpdate = 0x27a0,
        KickReason = 0x2839,
        ...
        LiveRegionAccountRestoreResult = 0x27be,
        LiveRegionCharacterCopyResult = 0x27bc,
        LiveRegionGetAccountCharacterListResult = 0x27b1,
        LoadCufProfiles = 0x25ce,
        LoadEquipmentSet = 0x2757,
        LoadSelectedTrophyResult = 0x2812,
        LoginSetTimeSpeed = 0x2756,
        ...
        LootLegacyRulesInEffect = 0x287b,
        LootList = 0x278c,
        ...
        MailListResult = 0x27a2,
        MailQueryNextTimeResult = 0x27a3,
        MapObjectivesInit = 0x27ab,
        ...
        ModifyChargeRecoverySpeed = 0x27b5,
        ModifyCooldown = 0x27b3,
        ModifyCooldownRecoverySpeed = 0x27b4,
        ModifyPartyRange = 0x278f,
        Motd = 0x2baf,
        MountEquipmentApplyResult = 0x28b7,
        MountResult = 0x257a,
        ...
        OnCancelExpectedRideVehicleAura = 0x2726,
        OnMonsterMove = 0x2da2,
        OpenAlliedRaceDetailsGiver = 0x2843,
        OpenContainer = 0x276d,
        OpenLfgDungeonFinder = 0x2a31,
        OpenShipmentNpcFromGossip = 0x27e7,
        OpenShipmentNpcResult = 0x27e9,
        OpenTransmogrifier = 0x2840,
        OverrideLight = 0x26ef,
        PageText = 0x2762,
        PartyCommandResult = 0x27e4,
        PartyInvite = 0x25cf,
        PartyKillLog = 0x27a7,
        PartyMemberState = 0x27a5,
        PartyMemberStateUpdate = 0x27a4,
        PartyUpdate = 0x260c,
        PauseMirrorTimer = 0x2759,
        PendingRaidLock = 0x273a,
        PetitionAlreadySigned = 0x25b8,
        PetitionRenameGuildResponse = 0x29fa,
        PetitionShowList = 0x26f2,
        PetitionShowSignatures = 0x26f3,
        PetitionSignResults = 0x2799,
        PetActionFeedback = 0x2796,
        ...
        PlayerSkinned = 0x2791,
        PlayerTabardVendorActivate = 0x27a6,
        PlayMusic = 0x27b8,
        PlayObjectSound = 0x27b9,
        PlayOneShotAnimKit = 0x277b,
        PlayOrphanSpellVisual = 0x2c47,
        PlayScene = 0x2656,
        PlaySound = 0x27b7,
        PlaySpeakerbotSound = 0x27ba,
        PlaySpellVisual = 0x2c45,
        PlaySpellVisualKit = 0x2c49,
        PlayTimeWarning = 0x2744,
        Pong = 0x304e,
        PowerUpdate = 0x2707,
        PreRessurect = 0x27b6,
        PrintNotification = 0x25e1,
        ProcResist = 0x27a8,
        ProposeLevelGrant = 0x271b,
        PushSpellToActionBar = 0x2c51,
        PvpCredit = 0x2720,
        PvpLogData = 0x25b3,
        PvpMatchStart = 0x28b1,
        ...
        QueryTimeResponse = 0x2724,
        QueryTreasurePickerResponse = 0x2852,
        ...
        RafEmailEnabledResponse = 0x27d5,
        RaidDifficultySet = 0x27f8,
        RaidGroupOnly = 0x27fa,
        ...
        ReadItemResultFailed = 0x27f4,
        ReadItemResultOk = 0x27ee,
        RealmLookupInformation = 0x2819,
        RealmQueryResponse = 0x26ee,
        RecruitAFriendResponse = 0x27d6,
        ReferAFriendExpired = 0x276b,
        ...
        ScenarioBoot = 0x27f5,
        ScenarioCompleted = 0x2836,
        ScenarioPois = 0x2652,
        ScenarioProgressUpdate = 0x264b,
        ScenarioSetShouldShowCriteria = 0x2846,
        ScenarioSpellUpdate = 0x2845,
        ...
        TradeStatus = 0x2582,
        TradeUpdated = 0x2581,
        TrainerBuyFailed = 0x271f,
        TrainerList = 0x271e,
        TransferAborted = 0x274a,
        TransferPending = 0x25e5,
        TransmogCollectionUpdate = 0x25c6,
        TransmogSetCollectionUpdate = 0x25c7,
        TriggerCinematic = 0x2817,
        TriggerMovie = 0x26fe,
        TurnInPetitionResult = 0x279b,
        TutorialFlags = 0x2809,
        TutorialHighlightSpell = 0x284c,
        TutorialUnhighlightSpell = 0x284b,
        TwitterStatus = 0x2ffd,
        UiTime = 0x275d,
        UndeleteCharacterResponse = 0x281a,
        UndeleteCooldownStatusResponse = 0x281b,
        UnlearnedSpells = 0x2c4e,
        UpdateAccountData = 0x2752,
        UpdateActionButtons = 0x25f6,
        UpdateCelestialBody = 0x286b,
        UpdateCharacterFlags = 0x280f,
        ...
        UpdateTaskProgress = 0x27dd,
        UpdateWeeklySpellUsage = 0x2c19,
        UpdateWorldState = 0x2795,
        UserlistAdd = 0x2bb9,
        UserlistRemove = 0x2bba,
        UserlistUpdate = 0x2bbb,
        UseEquipmentSetResult = 0x279c,
        VendorInventory = 0x25ca,
        VignetteUpdate = 0x27bd,
        ...
        WardenData = 0x2576,
        WarfrontCompleted = 0x27ae,
        WargameRequestSuccessfullySentToOpponent = 0x25b4,
        Weather = 0x26d5,
        WeeklySpellUsage = 0x2c18,
        Who = 0x2bae,
        WhoIs = 0x26d4,
        WorldQuestUpdate = 0x2853,
        WorldServerInfo = 0x25c2,
        WorldText = 0x2838,
        WowTokenAuctionSold = 0x2825,
        WowTokenBuyRequestConfirmation = 0x2827,
        WowTokenBuyResultConfirmation = 0x2828,
        WowTokenCanRedeemForBalanceResult = 0x2861,
        WowTokenCanVeteranBuyResult = 0x2826,
        WowTokenDistributionGlueUpdate = 0x2820,
        WowTokenDistributionUpdate = 0x2821,
        WowTokenMarketPriceResponse = 0x2822,
        WowTokenRedeemGameTimeUpdated = 0x2829,
        WowTokenRedeemRequestConfirmation = 0x282a,
        WowTokenRedeemResult = 0x282b,
        WowTokenSellRequestConfirmation = 0x2823,
        WowTokenSellResultConfirmation = 0x2824,
        WowTokenUpdateAuctionableListResponse = 0x282c,
        XpGainAborted = 0x25e0,
        XpGainEnabled = 0x27f9,

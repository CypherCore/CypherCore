...
namespace Framework.Constants
{
    ...
    public enum GameError : uint
    {
        ...
        TransmogInvalidActionTrialOfStyle = 921,
        VoidDepositFull = 922,
        VoidWithdrawFull = 923,
        VoidStorageWrapped = 924,
        VoidStorageStackable = 925,
        VoidStorageUnbound = 926,
        VoidStorageRepair = 927,
        VoidStorageCharges = 928,
        VoidStorageQuest = 929,
        VoidStorageConjured = 930,
        VoidStorageMail = 931,
        VoidStorageBag = 932,
        VoidTransferStorageFull = 933,
        VoidTransferInvFull = 934,
        VoidTransferInternalError = 935,
        VoidTransferItemInvalid = 936,
        DifficultyDisabledInLfg = 937,
        VoidStorageUnique = 938,
        VoidStorageLoot = 939,
        VoidStorageHoliday = 940,
        VoidStorageDuration = 941,
        VoidStorageLoadFailed = 942,
        VoidStorageInvalidItem = 943,
        VoidStorageAccountItem = 944,
        ParentalControlsChatMuted = 945,
        SorStartExperienceIncomplete = 946,
        SorInvalidEmail = 947,
        SorInvalidComment = 948,
        ChallengeModeResetCooldownS = 949,
        ChallengeModeResetKeystone = 950,
        PetJournalAlreadyInLoadout = 951,
        ReportSubmittedSuccessfully = 952,
        ReportSubmissionFailed = 953,
        SuggestionSubmittedSuccessfully = 954,
        BugSubmittedSuccessfully = 955,
        ChallengeModeEnabled = 956,
        ChallengeModeDisabled = 957,
        PetbattleCreateFailed = 958,
        PetbattleNotHere = 959,
        PetbattleNotHereOnTransport = 960,
        PetbattleNotHereUnevenGround = 961,
        PetbattleNotHereObstructed = 962,
        PetbattleNotWhileInCombat = 963,
        PetbattleNotWhileDead = 964,
        PetbattleNotWhileFlying = 965,
        PetbattleTargetInvalid = 966,
        PetbattleTargetOutOfRange = 967,
        PetbattleTargetNotCapturable = 968,
        PetbattleNotATrainer = 969,
        PetbattleDeclined = 970,
        PetbattleInBattle = 971,
        PetbattleInvalidLoadout = 972,
        PetbattleAllPetsDead = 973,
        PetbattleNoPetsInSlots = 974,
        PetbattleNoAccountLock = 975,
        PetbattleWildPetTapped = 976,
        PetbattleRestrictedAccount = 977,
        PetbattleOpponentNotAvailable = 978,
        PetbattleNotWhileInMatchedBattle = 979,
        CantHaveMorePetsOfThatType = 980,
        CantHaveMorePets = 981,
        PvpMapNotFound = 982,
        PvpMapNotSet = 983,
        PetbattleQueueQueued = 984,
        PetbattleQueueAlreadyQueued = 985,
        PetbattleQueueJoinFailed = 986,
        PetbattleQueueJournalLock = 987,
        PetbattleQueueRemoved = 988,
        PetbattleQueueProposalDeclined = 989,
        PetbattleQueueProposalTimeout = 990,
        PetbattleQueueOpponentDeclined = 991,
        PetbattleQueueRequeuedInternal = 992,
        PetbattleQueueRequeuedRemoved = 993,
        PetbattleQueueSlotLocked = 994,
        PetbattleQueueSlotEmpty = 995,
        PetbattleQueueSlotNoTracker = 996,
        PetbattleQueueSlotNoSpecies = 997,
        PetbattleQueueSlotCantBattle = 998,
        PetbattleQueueSlotRevoked = 999,
        PetbattleQueueSlotDead = 1000,
        PetbattleQueueSlotNoPet = 1001,
        PetbattleQueueNotWhileNeutral = 1002,
        PetbattleGameTimeLimitWarning = 1003,
        PetbattleGameRoundsLimitWarning = 1004,
        HasRestriction = 1005,
        ItemUpgradeItemTooLowLevel = 1006,
        ItemUpgradeNoPath = 1007,
        ItemUpgradeNoMoreUpgrades = 1008,
        BonusRollEmpty = 1009,
        ChallengeModeFull = 1010,
        ChallengeModeInProgress = 1011,
        ChallengeModeIncorrectKeystone = 1012,
        StartRestrictedChallengeMode = 1013,
        BattletagFriendNotFound = 1014,
        BattletagFriendNotValid = 1015,
        BattletagFriendNotAllowed = 1016,
        BattletagFriendThrottled = 1017,
        BattletagFriendSuccess = 1018,
        PetTooHighLevelToUncage = 1019,
        PetbattleInternal = 1020,
        CantCagePetYet = 1021,
        NoLootInChallengeMode = 1022,
        QuestPetBattleVictoriesPvpIi = 1023,
        RoleCheckAlreadyInProgress = 1024,
        RecruitAFriendAccountLimit = 1025,
        RecruitAFriendFailed = 1026,
        SetLootPersonal = 1027,
        SetLootMethodFailedCombat = 1028,
        ReagentBankFull = 1029,
        ReagentBankLocked = 1030,
        GarrisonBuildingExists = 1031,
        GarrisonInvalidPlot = 1032,
        GarrisonInvalidBuildingid = 1033,
        GarrisonInvalidPlotBuilding = 1034,
        GarrisonRequiresBlueprint = 1035,
        GarrisonNotEnoughCurrency = 1036,
        GarrisonNotEnoughGold = 1037,
        GarrisonCompleteMissionWrongFollowerType = 1038,
        AlreadyUsingLfgList = 1039,
        RestrictedAccountLfgListTrial = 1040,
        ToyUseLimitReached = 1041,
        ToyAlreadyKnown = 1042,
        TransmogSetAlreadyKnown = 1043,
        NotEnoughCurrency = 1044,
        SpecIsDisabled = 1045,
        FeatureRestrictedTrial = 1046,
        CantBeObliterated = 1047,
        CantBeScrapped = 1048,
        CantBeRecrafted = 1049,
        ArtifactRelicDoesNotMatchArtifact = 1050,
        MustEquipArtifact = 1051,
        CantDoThatRightNow = 1052,
        AffectingCombat = 1053,
        EquipmentManagerCombatSwapS = 1054,
        EquipmentManagerBagsFull = 1055,
        EquipmentManagerMissingItemS = 1056,
        MovieRecordingWarningPerf = 1057,
        MovieRecordingWarningDiskFull = 1058,
        MovieRecordingWarningNoMovie = 1059,
        MovieRecordingWarningRequirements = 1060,
        MovieRecordingWarningCompressing = 1061,
        NoChallengeModeReward = 1062,
        ClaimedChallengeModeReward = 1063,
        ChallengeModePeriodResetSs = 1064,
        CantDoThatChallengeModeActive = 1065,
        TalentFailedRestArea = 1066,
        CannotAbandonLastPet = 1067,
        TestCvarSetSss = 1068,
        QuestTurnInFailReason = 1069,
        ClaimedChallengeModeRewardOld = 1070,
        TalentGrantedByAura = 1071,
        ChallengeModeAlreadyComplete = 1072,
        GlyphTargetNotAvailable = 1073,
        PvpWarmodeToggleOn = 1074,
        PvpWarmodeToggleOff = 1075,
        SpellFailedLevelRequirement = 1076,
        SpellFailedCantFlyHere = 1077,
        BattlegroundJoinRequiresLevel = 1078,
        BattlegroundJoinDisqualified = 1079,
        BattlegroundJoinDisqualifiedNoName = 1080,
        VoiceChatGenericUnableToConnect = 1081,
        VoiceChatServiceLost = 1082,
        VoiceChatChannelNameTooShort = 1083,
        VoiceChatChannelNameTooLong = 1084,
        VoiceChatChannelAlreadyExists = 1085,
        VoiceChatTargetNotFound = 1086,
        VoiceChatTooManyRequests = 1087,
        VoiceChatPlayerSilenced = 1088,
        VoiceChatParentalDisableAll = 1089,
        VoiceChatDisabled = 1090,
        NoPvpReward = 1091,
        ClaimedPvpReward = 1092,
        AzeriteEssenceSelectionFailedEssenceNotUnlocked = 1093,
        AzeriteEssenceSelectionFailedCantRemoveEssence = 1094,
        AzeriteEssenceSelectionFailedConditionFailed = 1095,
        AzeriteEssenceSelectionFailedRestArea = 1096,
        AzeriteEssenceSelectionFailedSlotLocked = 1097,
        AzeriteEssenceSelectionFailedNotAtForge = 1098,
        AzeriteEssenceSelectionFailedHeartLevelTooLow = 1099,
        AzeriteEssenceSelectionFailedNotEquipped = 1100,
        SocketingGenericFailure = 1101,
        SocketingRequiresPunchcardredGem = 1102,
        SocketingPunchcardredGemOnlyInPunchcardredslot = 1103,
        SocketingRequiresPunchcardyellowGem = 1104,
        SocketingPunchcardyellowGemOnlyInPunchcardyellowslot = 1105,
        SocketingRequiresPunchcardblueGem = 1106,
        SocketingPunchcardblueGemOnlyInPunchcardblueslot = 1107,
        SocketingRequiresDominationShard = 1108,
        SocketingDominationShardOnlyInDominationslot = 1109,
        SocketingRequiresCypherGem = 1110,
        SocketingCypherGemOnlyInCypherslot = 1111,
        SocketingRequiresTinkerGem = 1112,
        SocketingTinkerGemOnlyInTinkerslot = 1113,
        SocketingRequiresPrimordialGem = 1114,
        SocketingPrimordialGemOnlyInPrimordialslot = 1115,
        SocketingRequiresFragranceGem = 1116,
        SocketingFragranceGemOnlyInFragranceslot = 1117,
        SocketingRequiresSingingThunderGem = 1118,
        SocketingSingingthunderGemOnlyInSingingthunderslot = 1119,
        SocketingRequiresSingingSeaGem = 1120,
        SocketingSingingseaGemOnlyInSingingseaslot = 1121,
        SocketingRequiresSingingWindGem = 1122,
        SocketingSingingwindGemOnlyInSingingwindslot = 1123,
        SocketingRequiresFiberGem = 1124,
        SocketingFiberGemOnlyInFiberslot = 1125,
        LevelLinkingResultLinked = 1126,
        LevelLinkingResultUnlinked = 1127,
        ClubFinderErrorPostClub = 1128,
        ClubFinderErrorApplyClub = 1129,
        ClubFinderErrorRespondApplicant = 1130,
        ClubFinderErrorCancelApplication = 1131,
        ClubFinderErrorTypeAcceptApplication = 1132,
        ClubFinderErrorTypeNoInvitePermissions = 1133,
        ClubFinderErrorTypeNoPostingPermissions = 1134,
        ClubFinderErrorTypeApplicantList = 1135,
        ClubFinderErrorTypeApplicantListNoPerm = 1136,
        ClubFinderErrorTypeFinderNotAvailable = 1137,
        ClubFinderErrorTypeGetPostingIds = 1138,
        ClubFinderErrorTypeJoinApplication = 1139,
        ClubFinderErrorTypeRealmNotEligible = 1140,
        ClubFinderErrorTypeFlaggedRename = 1141,
        ClubFinderErrorTypeFlaggedDescriptionChange = 1142,
        ItemInteractionNotEnoughGold = 1143,
        ItemInteractionNotEnoughCurrency = 1144,
        ItemInteractionNoConversionOutput = 1145,
        PlayerChoiceErrorPendingChoice = 1146,
        SoulbindInvalidConduit = 1147,
        SoulbindInvalidConduitItem = 1148,
        SoulbindInvalidTalent = 1149,
        SoulbindDuplicateConduit = 1150,
        ActivateSoulbindS = 1151,
        ActivateSoulbindFailedRestArea = 1152,
        CantUseProfanity = 1153,
        NotInPetBattle = 1154,
        NotInNpe = 1155,
        NoSpec = 1156,
        NoDominationshardOverwrite = 1157,
        UseWeeklyRewardsDisabled = 1158,
        CrossFactionGroupJoined = 1159,
        CantTargetUnfriendlyInOverworld = 1160,
        EquipablespellsSlotsFull = 1161,
        ItemModAppearanceGroupAlreadyKnown = 1162,
        CantBulkSellItemWithRefund = 1163,
        NoSoulboundItemInAccountBank = 1164,
        NoRefundableItemInAccountBank = 1165,
        CantDeleteInAccountBank = 1166,
        NoImmediateContainerInAccountBank = 1167,
        NoOpenImmediateContainerInAccountBank = 1168,
        CantTradeAccountItem = 1169,
        NoAccountInventoryLock = 1170,
        BankNotAccessible = 1171,
        TooManyAccountBankTabs = 1172,
        BankTabNotUnlocked = 1173,
        AccountMoneyLocked = 1174,
        BankTabInvalidName = 1175,
        BankTabInvalidText = 1176,
        CharacterBankNotConverted = 1177,
        NoSalvagedItemsInAccountBank = 1178,
        WowLabsPartyErrorTypePartyIsFull = 1179,
        WowLabsPartyErrorTypeMaxInviteSent = 1180,
        WowLabsPartyErrorTypePlayerAlreadyInvited = 1181,
        WowLabsPartyErrorTypePartyInviteInvalid = 1182,
        WowLabsLobbyMatchmakerErrorEnterQueueFailed = 1183,
        WowLabsLobbyMatchmakerErrorLeaveQueueFailed = 1184,
        WowLabsSetWowLabsAreaIdFailed = 1185,
        PlunderstormCannotQueue = 1186,
        TargetIsSelfFoundCannotTrade = 1187,
        PlayerIsSelfFoundCannotTrade = 1188,
        MailRecepientIsSelfFoundCannotReceiveMail = 1189,
        PlayerIsSelfFoundCannotSendMail = 1190,
        PlayerIsSelfFoundCannotUseAuctionHouse = 1191,
        MailTargetCannotReceiveMail = 1192,
        RemixInvalidTransferRequest = 1193,
        FollowerDungeonInvalidTransferRequest = 1194,
        CurrencyTransferInvalidCharacter = 1195,
        CurrencyTransferInvalidCurrency = 1196,
        CurrencyTransferInsufficientCurrency = 1197,
        CurrencyTransferMaxQuantity = 1198,
        CurrencyTransferNoValidSource = 1199,
        CurrencyTransferCharacterLoggedIn = 1200,
        CurrencyTransferServerError = 1201,
        CurrencyTransferUnmetRequirements = 1202,
        CurrencyTransferTransactionInProgress = 1203,
        CurrencyTransferDisabled = 1204,
        NoOwnedHouseInThisNeighborhoodMap = 1205,
        HousingResultNeighborhoodNotFound = 1206,
        InvitedToNeighborhood = 1207,
        NeighborhoodOwnerTransferredS = 1208,
        NotWhileHouseEdit = 1209,
        NotWhileHouseInspectMode = 1210,
        NewPartyNeighborhoodReservation = 1211,
        HouseMoved = 1212,
        CharterSignatureRequestSent = 1213,
        CharterSignatureReceived = 1214,
        CharterSignatureRequestFailedMissingExpansion = 1215,
        CharterSignatureRequestFailedDuplicateSignature = 1216,
        CharterSignatureRequestFailedGeneric = 1217,
        CharterSystemRequestFailedGeneric = 1218,
        HousingActionUnavailable = 1219,
        HousingExteriorFailsafeReset = 1220,
        HousingResultMissingExpansionAccess = 1221,
        HousingResultPermissionDenied = 1222,
        HousingActionNoentry = 1223,
        GuildNeighborhoodBuiltHouseS = 1224,
        GuildNeighborhoodSoldHouseS = 1225,
        GuildNeighborhoodNewSubdivision = 1226,
        GuildNeighborhoodRenameS = 1227,
        CharterNeighborhoodRename = 1228,
        CharterSignatureRemoved = 1229,
        EndeavorRewardAvailable = 1230,
        HousingResultCosmeticOwnerNotInGuild = 1231,
        HousingResultPlotNotVacant = 1232,
        HousingResultPlotReserved = 1233,
        HousingResultMissingPrivateNeighborhoodInvite = 1234,
        CharterNeighborhoodOwnershipTransferSuccess = 1235,
        CharterNeighborhoodRenameNotificationSs = 1236,
        RecentAllyPinServerError = 1237,
        PvpTrainingGroundsDisabled = 1238,
        SoloJoinTrainingGround = 1239,
        LfgJoinedTrainingGroundsQueue = 1240,
    }

...
namespace Framework.Constants
{
    ...
    public enum GameError : uint
    {
        ...
        GenericThrottle = 486,
        TargetStunned = 487,
        MustRepairDurability = 488,
        RaidYouJoined = 489,
        RaidYouLeft = 490,
        InstanceGroupJoinedWithParty = 491,
        InstanceGroupJoinedWithRaid = 492,
        RaidMemberAddedS = 493,
        RaidMemberRemovedS = 494,
        InstanceGroupAddedS = 495,
        InstanceGroupRemovedS = 496,
        ClickOnItemToFeed = 497,
        TooManyChatChannels = 498,
        LootRollPending = 499,
        LootPlayerNotFound = 500,
        NotInRaid = 501,
        LoggingOut = 502,
        TargetLoggingOut = 503,
        NotWhileMounted = 504,
        NotWhileShapeshifted = 505,
        NotInCombat = 506,
        NotWhileDisarmed = 507,
        PetBroken = 508,
        TalentWipeError = 509,
        SpecWipeError = 510,
        GlyphWipeError = 511,
        PetSpecWipeError = 512,
        FeignDeathResisted = 513,
        MeetingStoneInQueueS = 514,
        MeetingStoneLeftQueueS = 515,
        MeetingStoneOtherMemberLeft = 516,
        MeetingStonePartyKickedFromQueue = 517,
        MeetingStoneMemberStillInQueue = 518,
        MeetingStoneSuccess = 519,
        MeetingStoneInProgress = 520,
        MeetingStoneMemberAddedS = 521,
        MeetingStoneGroupFull = 522,
        MeetingStoneNotLeader = 523,
        MeetingStoneInvalidLevel = 524,
        MeetingStoneTargetNotInParty = 525,
        MeetingStoneTargetInvalidLevel = 526,
        MeetingStoneMustBeLeader = 527,
        MeetingStoneNoRaidGroup = 528,
        MeetingStoneNeedParty = 529,
        MeetingStoneNotFound = 530,
        MeetingStoneTargetInVehicle = 531,
        GuildemblemSame = 532,
        EquipTradeItem = 533,
        PvpToggleOn = 534,
        PvpToggleOff = 535,
        GroupJoinBattlegroundDeserters = 536,
        GroupJoinBattlegroundDead = 537,
        GroupJoinBattlegroundS = 538,
        GroupJoinBattlegroundFail = 539,
        GroupJoinBattlegroundTooMany = 540,
        SoloJoinBattlegroundS = 541,
        JoinSingleScenarioS = 542,
        BattlegroundTooManyQueues = 543,
        BattlegroundCannotQueueForRated = 544,
        BattledgroundQueuedForRated = 545,
        BattlegroundTeamLeftQueue = 546,
        BattlegroundNotInBattleground = 547,
        AlreadyInArenaTeamS = 548,
        InvalidPromotionCode = 549,
        BgPlayerJoinedSs = 550,
        BgPlayerLeftS = 551,
        RestrictedAccount = 552,
        RestrictedAccountTrial = 553,
        PlayTimeExceeded = 554,
        ApproachingPartialPlayTime = 555,
        ApproachingPartialPlayTime2 = 556,
        ApproachingNoPlayTime = 557,
        ApproachingNoPlayTime2 = 558,
        UnhealthyTime = 559,
        ChatRestrictedTrial = 560,
        ChatThrottled = 561,
        MailReachedCap = 562,
        InvalidRaidTarget = 563,
        RaidLeaderReadyCheckStartS = 564,
        ReadyCheckInProgress = 565,
        ReadyCheckThrottled = 566,
        DungeonDifficultyFailed = 567,
        DungeonDifficultyChangedS = 568,
        TradeWrongRealm = 569,
        TradeNotOnTaplist = 570,
        ChatPlayerAmbiguousS = 571,
        LootCantLootThatNow = 572,
        LootMasterInvFull = 573,
        LootMasterUniqueItem = 574,
        LootMasterOther = 575,
        FilteringYouS = 576,
        UsePreventedByMechanicS = 577,
        ItemUniqueEquippable = 578,
        LfgLeaderIsLfmS = 579,
        LfgPending = 580,
        CantSpeakLangage = 581,
        VendorMissingTurnins = 582,
        BattlegroundNotInTeam = 583,
        NotInBattleground = 584,
        NotEnoughHonorPoints = 585,
        NotEnoughArenaPoints = 586,
        SocketingRequiresMetaGem = 587,
        SocketingMetaGemOnlyInMetaslot = 588,
        SocketingRequiresHydraulicGem = 589,
        SocketingHydraulicGemOnlyInHydraulicslot = 590,
        SocketingRequiresCogwheelGem = 591,
        SocketingCogwheelGemOnlyInCogwheelslot = 592,
        SocketingItemTooLowLevel = 593,
        ItemMaxCountSocketed = 594,
        SystemDisabled = 595,
        QuestFailedTooManyDailyQuestsI = 596,
        ItemMaxCountEquippedSocketed = 597,
        ItemUniqueEquippableSocketed = 598,
        UserSquelched = 599,
        TooMuchGold = 600,
        NotBarberSitting = 601,
        QuestFailedCais = 602,
        InviteRestrictedTrial = 603,
        VoiceIgnoreFull = 604,
        VoiceIgnoreSelf = 605,
        VoiceIgnoreNotFound = 606,
        VoiceIgnoreAlreadyS = 607,
        VoiceIgnoreAddedS = 608,
        VoiceIgnoreRemovedS = 609,
        VoiceIgnoreAmbiguous = 610,
        VoiceIgnoreDeleted = 611,
        UnknownMacroOptionS = 612,
        NotDuringArenaMatch = 613,
        PlayerSilenced = 614,
        PlayerUnsilenced = 615,
        ComsatDisconnect = 616,
        ComsatReconnectAttempt = 617,
        ComsatConnectFail = 618,
        MailInvalidAttachmentSlot = 619,
        MailTooManyAttachments = 620,
        MailInvalidAttachment = 621,
        MailAttachmentExpired = 622,
        VoiceChatParentalDisableMic = 623,
        ProfaneChatName = 624,
        PlayerSilencedEcho = 625,
        PlayerUnsilencedEcho = 626,
        LootCantLootThat = 627,
        ArenaExpiredCais = 628,
        GroupActionThrottled = 629,
        AlreadyPickpocketed = 630,
        NameInvalid = 631,
        NameNoName = 632,
        NameTooShort = 633,
        NameTooLong = 634,
        NameMixedLanguages = 635,
        NameProfane = 636,
        NameReserved = 637,
        NameThreeConsecutive = 638,
        NameInvalidSpace = 639,
        NameConsecutiveSpaces = 640,
        NameRussianConsecutiveSilentCharacters = 641,
        NameRussianSilentCharacterAtBeginningOrEnd = 642,
        NameDeclensionDoesntMatchBaseName = 643,
        ReferAFriendNotReferredBy = 644,
        ReferAFriendTargetTooHigh = 645,
        ReferAFriendInsufficientGrantableLevels = 646,
        ReferAFriendTooFar = 647,
        ReferAFriendDifferentFaction = 648,
        ReferAFriendNotNow = 649,
        ReferAFriendGrantLevelMaxI = 650,
        ReferAFriendSummonLevelMaxI = 651,
        ReferAFriendSummonCooldown = 652,
        ReferAFriendSummonOfflineS = 653,
        ReferAFriendInsufExpanLvl = 654,
        ReferAFriendNotInLfg = 655,
        ReferAFriendNoXrealm = 656,
        ReferAFriendMapIncomingTransferNotAllowed = 657,
        NotSameAccount = 658,
        BadOnUseEnchant = 659,
        TradeSelf = 660,
        TooManySockets = 661,
        ItemMaxLimitCategoryCountExceededIs = 662,
        TradeTargetMaxLimitCategoryCountExceededIs = 663,
        ItemMaxLimitCategorySocketedExceededIs = 664,
        ItemMaxLimitCategoryEquippedExceededIs = 665,
        ShapeshiftFormCannotEquip = 666,
        ItemInventoryFullSatchel = 667,
        ScalingStatItemLevelExceeded = 668,
        ScalingStatItemLevelTooLow = 669,
        PurchaseLevelTooLow = 670,
        GroupSwapFailed = 671,
        InviteInCombat = 672,
        InvalidGlyphSlot = 673,
        GenericNoValidTargets = 674,
        CalendarEventAlertS = 675,
        PetLearnSpellS = 676,
        PetLearnAbilityS = 677,
        PetSpellUnlearnedS = 678,
        InviteUnknownRealm = 679,
        InviteNoPartyServer = 680,
        InvitePartyBusy = 681,
        PartyTargetAmbiguous = 682,
        PartyLfgInviteRaidLocked = 683,
        PartyLfgBootLimit = 684,
        PartyLfgBootCooldownS = 685,
        PartyLfgBootNotEligibleS = 686,
        PartyLfgBootInpatientTimerS = 687,
        PartyLfgBootInProgress = 688,
        PartyLfgBootTooFewPlayers = 689,
        PartyLfgBootVoteSucceeded = 690,
        PartyLfgBootVoteFailed = 691,
        PartyLfgBootInCombat = 692,
        PartyLfgBootDungeonComplete = 693,
        PartyLfgBootLootRolls = 694,
        PartyLfgBootVoteRegistered = 695,
        PartyPrivateGroupOnly = 696,
        PartyLfgTeleportInCombat = 697,
        RaidDisallowedByLevel = 698,
        RaidDisallowedByCrossRealm = 699,
        PartyRoleNotAvailable = 700,
        JoinLfgObjectFailed = 701,
        LfgRemovedLevelup = 702,
        LfgRemovedXpToggle = 703,
        LfgRemovedFactionChange = 704,
        BattlegroundInfoThrottled = 705,
        BattlegroundAlreadyIn = 706,
        ArenaTeamChangeFailedQueued = 707,
        ArenaTeamPermissions = 708,
        NotWhileFalling = 709,
        NotWhileMoving = 710,
        NotWhileFatigued = 711,
        MaxSockets = 712,
        MultiCastActionTotemS = 713,
        BattlegroundJoinLevelup = 714,
        RemoveFromPvpQueueXpGain = 715,
        BattlegroundJoinXpGain = 716,
        BattlegroundJoinMercenary = 717,
        BattlegroundJoinTooManyHealers = 718,
        BattlegroundJoinRatedTooManyHealers = 719,
        BattlegroundJoinTooManyTanks = 720,
        BattlegroundJoinTooManyDamage = 721,
        RaidDifficultyFailed = 722,
        RaidDifficultyChangedS = 723,
        LegacyRaidDifficultyChangedS = 724,
        RaidLockoutChangedS = 725,
        RaidConvertedToParty = 726,
        PartyConvertedToRaid = 727,
        PlayerDifficultyChangedS = 728,
        GmresponseDbError = 729,
        BattlegroundJoinRangeIndex = 730,
        ArenaJoinRangeIndex = 731,
        RemoveFromPvpQueueFactionChange = 732,
        BattlegroundJoinFailed = 733,
        BattlegroundJoinNoValidSpecForRole = 734,
        BattlegroundJoinRespec = 735,
        BattlegroundInvitationDeclined = 736,
        BattlegroundJoinTimedOut = 737,
        BattlegroundDupeQueue = 738,
        BattlegroundJoinMustCompleteQuest = 739,
        InBattlegroundRespec = 740,
        MailLimitedDurationItem = 741,
        YellRestrictedTrial = 742,
        ChatRaidRestrictedTrial = 743,
        LfgRoleCheckFailed = 744,
        LfgRoleCheckFailedTimeout = 745,
        LfgRoleCheckFailedNotViable = 746,
        LfgReadyCheckFailed = 747,
        LfgReadyCheckFailedTimeout = 748,
        LfgGroupFull = 749,
        LfgNoLfgObject = 750,
        LfgNoSlotsPlayer = 751,
        LfgNoSlotsParty = 752,
        LfgNoSpec = 753,
        LfgMismatchedSlots = 754,
        LfgMismatchedSlotsLocalXrealm = 755,
        LfgPartyPlayersFromDifferentRealms = 756,
        LfgMembersNotPresent = 757,
        LfgGetInfoTimeout = 758,
        LfgInvalidSlot = 759,
        LfgDeserterPlayer = 760,
        LfgDeserterParty = 761,
        LfgDead = 762,
        LfgRandomCooldownPlayer = 763,
        LfgRandomCooldownParty = 764,
        LfgTooManyMembers = 765,
        LfgTooFewMembers = 766,
        LfgProposalFailed = 767,
        LfgProposalDeclinedSelf = 768,
        LfgProposalDeclinedParty = 769,
        LfgNoSlotsSelected = 770,
        LfgNoRolesSelected = 771,
        LfgRoleCheckInitiated = 772,
        LfgReadyCheckInitiated = 773,
        LfgPlayerDeclinedRoleCheck = 774,
        LfgPlayerDeclinedReadyCheck = 775,
        LfgJoinedQueue = 776,
        LfgJoinedFlexQueue = 777,
        LfgJoinedRfQueue = 778,
        LfgJoinedScenarioQueue = 779,
        LfgJoinedWorldPvpQueue = 780,
        LfgJoinedBattlefieldQueue = 781,
        LfgJoinedList = 782,
        LfgLeftQueue = 783,
        LfgLeftList = 784,
        LfgRoleCheckAborted = 785,
        LfgReadyCheckAborted = 786,
        LfgCantUseBattleground = 787,
        LfgCantUseDungeons = 788,
        LfgReasonTooManyLfg = 789,
        InvalidTeleportLocation = 790,
        TooFarToInteract = 791,
        BattlegroundPlayersFromDifferentRealms = 792,
        DifficultyChangeCooldownS = 793,
        DifficultyChangeCombatCooldownS = 794,
        DifficultyChangeWorldstate = 795,
        DifficultyChangeEncounter = 796,
        DifficultyChangeCombat = 797,
        DifficultyChangePlayerBusy = 798,
        DifficultyChangeAlreadyStarted = 799,
        DifficultyChangeOtherHeroicS = 800,
        DifficultyChangeHeroicInstanceAlreadyRunning = 801,
        ArenaTeamPartySize = 802,
        QuestForceRemovedS = 803,
        AttackNoActions = 804,
        InRandomBg = 805,
        InNonRandomBg = 806,
        AuctionEnoughItems = 807,
        BnFriendSelf = 808,
        BnFriendAlready = 809,
        BnFriendBlocked = 810,
        BnFriendListFull = 811,
        BnFriendRequestSent = 812,
        BnBroadcastThrottle = 813,
        BgDeveloperOnly = 814,
        CurrencySpellSlotMismatch = 815,
        CurrencyNotTradable = 816,
        RequiresExpansionS = 817,
        QuestFailedSpell = 818,
        TalentFailedNotEnoughTalentsInPrimaryTree = 819,
        TalentFailedNoPrimaryTreeSelected = 820,
        TalentFailedCantRemoveTalent = 821,
        TalentFailedUnknown = 822,
        WargameRequestFailure = 823,
        RankRequiresAuthenticator = 824,
        GuildBankVoucherFailed = 825,
        WargameRequestSent = 826,
        RequiresAchievementI = 827,
        RefundResultExceedMaxCurrency = 828,
        CantBuyQuantity = 829,
        ItemIsBattlePayLocked = 830,
        PartyAlreadyInBattlegroundQueue = 831,
        PartyConfirmingBattlegroundQueue = 832,
        BattlefieldTeamPartySize = 833,
        InsuffTrackedCurrencyIs = 834,
        NotOnTournamentRealm = 835,
        GuildTrialAccountTrial = 836,
        GuildTrialAccountVeteran = 837,
        GuildUndeletableDueToLevel = 838,
        CantDoThatInAGroup = 839,
        GuildLeaderReplaced = 840,
        TransmogrifyCantEquip = 841,
        TransmogrifyInvalidItemType = 842,
        TransmogrifyNotSoulbound = 843,
        TransmogrifyInvalidSource = 844,
        TransmogrifyInvalidDestination = 845,
        TransmogrifyMismatch = 846,
        TransmogrifyLegendary = 847,
        TransmogrifySameItem = 848,
        TransmogrifySameAppearance = 849,
        TransmogrifyNotEquipped = 850,
        VoidDepositFull = 851,
        VoidWithdrawFull = 852,
        VoidStorageWrapped = 853,
        VoidStorageStackable = 854,
        VoidStorageUnbound = 855,
        VoidStorageRepair = 856,
        VoidStorageCharges = 857,
        VoidStorageQuest = 858,
        VoidStorageConjured = 859,
        VoidStorageMail = 860,
        VoidStorageBag = 861,
        VoidTransferStorageFull = 862,
        VoidTransferInvFull = 863,
        VoidTransferInternalError = 864,
        VoidTransferItemInvalid = 865,
        DifficultyDisabledInLfg = 866,
        VoidStorageUnique = 867,
        VoidStorageLoot = 868,
        VoidStorageHoliday = 869,
        VoidStorageDuration = 870,
        VoidStorageLoadFailed = 871,
        VoidStorageInvalidItem = 872,
        ParentalControlsChatMuted = 873,
        SorStartExperienceIncomplete = 874,
        SorInvalidEmail = 875,
        SorInvalidComment = 876,
        ChallengeModeResetCooldownS = 877,
        ChallengeModeResetKeystone = 878,
        PetJournalAlreadyInLoadout = 879,
        ReportSubmittedSuccessfully = 880,
        ReportSubmissionFailed = 881,
        SuggestionSubmittedSuccessfully = 882,
        BugSubmittedSuccessfully = 883,
        ChallengeModeEnabled = 884,
        ChallengeModeDisabled = 885,
        PetbattleCreateFailed = 886,
        PetbattleNotHere = 887,
        PetbattleNotHereOnTransport = 888,
        PetbattleNotHereUnevenGround = 889,
        PetbattleNotHereObstructed = 890,
        PetbattleNotWhileInCombat = 891,
        PetbattleNotWhileDead = 892,
        PetbattleNotWhileFlying = 893,
        PetbattleTargetInvalid = 894,
        PetbattleTargetOutOfRange = 895,
        PetbattleTargetNotCapturable = 896,
        PetbattleNotATrainer = 897,
        PetbattleDeclined = 898,
        PetbattleInBattle = 899,
        PetbattleInvalidLoadout = 900,
        PetbattleAllPetsDead = 901,
        PetbattleNoPetsInSlots = 902,
        PetbattleNoAccountLock = 903,
        PetbattleWildPetTapped = 904,
        PetbattleRestrictedAccount = 905,
        PetbattleOpponentNotAvailable = 906,
        PetbattleNotWhileInMatchedBattle = 907,
        CantHaveMorePetsOfThatType = 908,
        CantHaveMorePets = 909,
        PvpMapNotFound = 910,
        PvpMapNotSet = 911,
        PetbattleQueueQueued = 912,
        PetbattleQueueAlreadyQueued = 913,
        PetbattleQueueJoinFailed = 914,
        PetbattleQueueJournalLock = 915,
        PetbattleQueueRemoved = 916,
        PetbattleQueueProposalDeclined = 917,
        PetbattleQueueProposalTimeout = 918,
        PetbattleQueueOpponentDeclined = 919,
        PetbattleQueueRequeuedInternal = 920,
        PetbattleQueueRequeuedRemoved = 921,
        PetbattleQueueSlotLocked = 922,
        PetbattleQueueSlotEmpty = 923,
        PetbattleQueueSlotNoTracker = 924,
        PetbattleQueueSlotNoSpecies = 925,
        PetbattleQueueSlotCantBattle = 926,
        PetbattleQueueSlotRevoked = 927,
        PetbattleQueueSlotDead = 928,
        PetbattleQueueSlotNoPet = 929,
        PetbattleQueueNotWhileNeutral = 930,
        PetbattleGameTimeLimitWarning = 931,
        PetbattleGameRoundsLimitWarning = 932,
        HasRestriction = 933,
        ItemUpgradeItemTooLowLevel = 934,
        ItemUpgradeNoPath = 935,
        ItemUpgradeNoMoreUpgrades = 936,
        BonusRollEmpty = 937,
        ChallengeModeFull = 938,
        ChallengeModeInProgress = 939,
        ChallengeModeIncorrectKeystone = 940,
        BattletagFriendNotFound = 941,
        BattletagFriendNotValid = 942,
        BattletagFriendNotAllowed = 943,
        BattletagFriendThrottled = 944,
        BattletagFriendSuccess = 945,
        PetTooHighLevelToUncage = 946,
        PetbattleInternal = 947,
        CantCagePetYet = 948,
        NoLootInChallengeMode = 949,
        QuestPetBattleVictoriesPvpIi = 950,
        RoleCheckAlreadyInProgress = 951,
        RecruitAFriendAccountLimit = 952,
        RecruitAFriendFailed = 953,
        SetLootPersonal = 954,
        SetLootMethodFailedCombat = 955,
        ReagentBankFull = 956,
        ReagentBankLocked = 957,
        GarrisonBuildingExists = 958,
        GarrisonInvalidPlot = 959,
        GarrisonInvalidBuildingid = 960,
        GarrisonInvalidPlotBuilding = 961,
        GarrisonRequiresBlueprint = 962,
        GarrisonNotEnoughCurrency = 963,
        GarrisonNotEnoughGold = 964,
        GarrisonCompleteMissionWrongFollowerType = 965,
        AlreadyUsingLfgList = 966,
        RestrictedAccountLfgListTrial = 967,
        ToyUseLimitReached = 968,
        ToyAlreadyKnown = 969,
        TransmogSetAlreadyKnown = 970,
        NotEnoughCurrency = 971,
        SpecIsDisabled = 972,
        FeatureRestrictedTrial = 973,
        CantBeObliterated = 974,
        CantBeScrapped = 975,
        ArtifactRelicDoesNotMatchArtifact = 976,
        MustEquipArtifact = 977,
        CantDoThatRightNow = 978,
        AffectingCombat = 979,
        EquipmentManagerCombatSwapS = 980,
        EquipmentManagerBagsFull = 981,
        EquipmentManagerMissingItemS = 982,
        MovieRecordingWarningPerf = 983,
        MovieRecordingWarningDiskFull = 984,
        MovieRecordingWarningNoMovie = 985,
        MovieRecordingWarningRequirements = 986,
        MovieRecordingWarningCompressing = 987,
        NoChallengeModeReward = 988,
        ClaimedChallengeModeReward = 989,
        ChallengeModePeriodResetSs = 990,
        CantDoThatChallengeModeActive = 991,
        TalentFailedRestArea = 992,
        CannotAbandonLastPet = 993,
        TestCvarSetSss = 994,
        QuestTurnInFailReason = 995,
        ClaimedChallengeModeRewardOld = 996,
        TalentGrantedByAura = 997,
        ChallengeModeAlreadyComplete = 998,
        GlyphTargetNotAvailable = 999,
        PvpWarmodeToggleOn = 1000,
        PvpWarmodeToggleOff = 1001,
        SpellFailedLevelRequirement = 1002,
        BattlegroundJoinRequiresLevel = 1003,
        BattlegroundJoinDisqualified = 1004,

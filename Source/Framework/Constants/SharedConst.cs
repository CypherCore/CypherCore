...
namespace Framework.Constants
{
    ...
    public enum GameError : uint
    {
        ...
        WowLabsPartyErrorTypePartyIsFull = 1178,
        WowLabsPartyErrorTypeMaxInviteSent = 1179,
        WowLabsPartyErrorTypePlayerAlreadyInvited = 1180,
        WowLabsPartyErrorTypePartyInviteInvalid = 1181,
        WowLabsLobbyMatchmakerErrorEnterQueueFailed = 1182,
        WowLabsLobbyMatchmakerErrorLeaveQueueFailed = 1183,
        WowLabsSetWowLabsAreaIdFailed = 1184,
        PlunderstormCannotQueue = 1185,
        TargetIsSelfFoundCannotTrade = 1186,
        PlayerIsSelfFoundCannotTrade = 1187,
        MailRecepientIsSelfFoundCannotReceiveMail = 1188,
        PlayerIsSelfFoundCannotSendMail = 1189,
        PlayerIsSelfFoundCannotUseAuctionHouse = 1190,
        MailTargetCannotReceiveMail = 1191,
        RemixInvalidTransferRequest = 1192,
        CurrencyTransferInvalidCharacter = 1193,
        CurrencyTransferInvalidCurrency = 1194,
        CurrencyTransferInsufficientCurrency = 1195,
        CurrencyTransferMaxQuantity = 1196,
        CurrencyTransferNoValidSource = 1197,
        CurrencyTransferCharacterLoggedIn = 1198,
        CurrencyTransferServerError = 1199,
        CurrencyTransferUnmetRequirements = 1200,
        CurrencyTransferTransactionInProgress = 1201,
        CurrencyTransferDisabled = 1202,
        NoOwnedHouseInThisNeighborhoodMap = 1203,
        HousingResultNeighborhoodNotFound = 1204,
        InvitedToNeighborhood = 1205,
        NeighborhoodOwnerTransferredS = 1206,
        NotWhileHouseEdit = 1207,
        NewPartyNeighborhoodReservation = 1208,
        HouseMoved = 1209,
        CharterSignatureRequestSent = 1210,
        CharterSignatureReceived = 1211,
        CharterSignatureRequestFailedMissingExpansion = 1212,
        CharterSignatureRequestFailedDuplicateSignature = 1213,
        CharterSignatureRequestFailedGeneric = 1214,
        CharterSystemRequestFailedGeneric = 1215,
        HousingActionUnavailable = 1216,
        HousingExteriorFailsafeReset = 1217,
        HousingResultMissingExpansionAccess = 1218,
        HousingResultPermissionDenied = 1219,
        GuildNeighborhoodBuiltHouseS = 1220,
        GuildNeighborhoodSoldHouseS = 1221,
        GuildNeighborhoodNewSubdivision = 1222,
        GuildNeighborhoodRenameS = 1223,
        CharterNeighborhoodRename = 1224,
        CharterSignatureRemoved = 1225,
        EndeavorRewardAvailable = 1226,
        HousingResultCosmeticOwnerNotInGuild = 1227,
        HousingResultPlotNotVacant = 1228,
        HousingResultPlotReserved = 1229,
        HousingResultMissingPrivateNeighborhoodInvite = 1230,
        CharterNeighborhoodOwnershipTransferSuccess = 1231,
        CharterNeighborhoodRenameNotificationS = 1232,
        RecentAllyPinServerError = 1233,
        PvpTrainingGroundsDisabled = 1234,
        SoloJoinTrainingGround = 1235,
        LfgJoinedTrainingGroundsQueue = 1236,
    }

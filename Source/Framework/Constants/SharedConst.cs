...
namespace Framework.Constants
{
    ...
    public enum GameError : uint
    {
        ...
        CurrencyTransferInvalidCharacter = 1194,
        CurrencyTransferInvalidCurrency = 1195,
        CurrencyTransferInsufficientCurrency = 1196,
        CurrencyTransferMaxQuantity = 1197,
        CurrencyTransferNoValidSource = 1198,
        CurrencyTransferCharacterLoggedIn = 1199,
        CurrencyTransferServerError = 1200,
        CurrencyTransferUnmetRequirements = 1201,
        CurrencyTransferTransactionInProgress = 1202,
        CurrencyTransferDisabled = 1203,
        NoOwnedHouseInThisNeighborhoodMap = 1204,
        HousingResultNeighborhoodNotFound = 1205,
        InvitedToNeighborhood = 1206,
        NeighborhoodOwnerTransferredS = 1207,
        NotWhileHouseEdit = 1208,
        NotWhileHouseInspectMode = 1209,
        NewPartyNeighborhoodReservation = 1210,
        HouseMoved = 1211,
        CharterSignatureRequestSent = 1212,
        CharterSignatureReceived = 1213,
        CharterSignatureRequestFailedMissingExpansion = 1214,
        CharterSignatureRequestFailedDuplicateSignature = 1215,
        CharterSignatureRequestFailedGeneric = 1216,
        CharterSystemRequestFailedGeneric = 1217,
        HousingActionUnavailable = 1218,
        HousingExteriorFailsafeReset = 1219,
        HousingResultMissingExpansionAccess = 1220,
        HousingResultPermissionDenied = 1221,
        HousingActionNoentry = 1222,
        GuildNeighborhoodBuiltHouseS = 1223,
        GuildNeighborhoodSoldHouseS = 1224,
        GuildNeighborhoodNewSubdivision = 1225,
        GuildNeighborhoodRenameS = 1226,
        CharterNeighborhoodRename = 1227,
        CharterSignatureRemoved = 1228,
        EndeavorRewardAvailable = 1229,
        HousingResultCosmeticOwnerNotInGuild = 1230,
        HousingResultPlotNotVacant = 1231,
        HousingResultPlotReserved = 1232,
        HousingResultMissingPrivateNeighborhoodInvite = 1233,
        CharterNeighborhoodOwnershipTransferSuccess = 1234,
        CharterNeighborhoodRenameNotificationSs = 1235,
        RecentAllyPinServerError = 1236,
        PvpTrainingGroundsDisabled = 1237,
        SoloJoinTrainingGround = 1238,
        LfgJoinedTrainingGroundsQueue = 1239,
    }

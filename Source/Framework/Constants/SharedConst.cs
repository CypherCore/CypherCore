...
namespace Framework.Constants
{
    ...
    public enum GameError : uint
    {
        ...
        GuildBankNotAvailable = 138,
        GuildCantPromoteS = 139,
        GuildCantDemoteS = 140,
        GuildNotInAGuild = 141,
        GuildInternal = 142,
        GuildLeaderIsS = 143,
        GuildLeaderChangedSs = 144,
        GuildDisbanded = 145,
        GuildNotAllied = 146,
        GuildNewLeaderNotAllied = 147,
        GuildLeaderLeave = 148,
        GuildRanksLocked = 149,
        GuildRankInUse = 150,
        GuildRankTooHighS = 151,
        GuildRankTooLowS = 152,
        GuildNameExistsS = 153,
        GuildWithdrawLimit = 154,
        GuildNotEnoughMoney = 155,
        GuildTooMuchMoney = 156,
        GuildBankConjuredItem = 157,
        GuildBankEquippedItem = 158,
        GuildBankBoundItem = 159,
        GuildBankQuestItem = 160,
        GuildBankWrappedItem = 161,
        GuildBankFull = 162,
        GuildBankWrongTab = 163,
        NoGuildCharter = 164,
        OutOfRange = 165,
        PlayerDead = 166,
        ClientLockedOut = 167,
        ClientOnTransport = 168,
        KilledByS = 169,
        LootLocked = 170,
        LootTooFar = 171,
        LootDidntKill = 172,
        ...
        LootStunned = 175,
        LootNoUi = 176,
        LootWhileInvulnerable = 177,
        NoLoot = 178,
        QuestAcceptedS = 179,
        QuestCompleteS = 180,
        QuestFailedS = 181,
        QuestFailedBagFullS = 182,
        QuestFailedMaxCountS = 183,
        QuestFailedLowLevel = 184,
        QuestFailedMissingItems = 185,
        QuestFailedWrongRace = 186,
        QuestFailedNotEnoughMoney = 187,
        QuestFailedExpansion = 188,
        QuestOnlyOneTimed = 189,
        QuestNeedPrereqs = 190,
        QuestNeedPrereqsCustom = 191,
        QuestAlreadyOn = 192,
        QuestAlreadyDone = 193,
        QuestAlreadyDoneDaily = 194,
        QuestHasInProgress = 195,
        QuestRewardExpI = 196,
        QuestRewardMoneyS = 197,
        QuestMustChoose = 198,
        QuestLogFull = 199,
        CombatDamageSsi = 200,
        InspectS = 201,
        CantUseItem = 202,
        CantUseItemInArena = 203,
        CantUseItemInRatedBattleground = 204,
        MustEquipItem = 205,
        PassiveAbility = 206,
        H2SkillNotFound = 207,
        NoAttackTarget = 208,
        InvalidAttackTarget = 209,
        AttackPvpTargetWhileUnflagged = 210,
        AttackStunned = 211,
        AttackPacified = 212,
        AttackMounted = 213,
        AttackFleeing = 214,
        ...
        AttackCharmed = 216,
        AttackDead = 217,
        AttackPreventedByMechanicS = 218,
        AttackChannel = 219,
        Taxisamenode = 220,
        Taxinosuchpath = 221,
        Taxiunspecifiedservererror = 222,
        Taxinotenoughmoney = 223,
        Taxitoofaraway = 224,
        Taxinovendornearby = 225,
        Taxinotvisited = 226,
        Taxiplayerbusy = 227,
        Taxiplayeralreadymounted = 228,
        Taxiplayershapeshifted = 229,
        Taxiplayermoving = 230,
        Taxinopaths = 231,
        Taxinoteligible = 232,
        Taxinotstanding = 233,
        Taxiincombat = 234,
        ...
        TradeComplete = 243,
        TradeBagFull = 244,
        TradeTargetBagFull = 245,
        TradeMaxCountExceeded = 246,
        TradeTargetMaxCountExceeded = 247,
        InventoryTradeTooManyUniqueItem = 248,
        AlreadyTrading = 249,
        MountInvalidmountee = 250,
        MountToofaraway = 251,
        MountAlreadymounted = 252,
        MountNotmountable = 253,
        MountNotyourpet = 254,
        MountOther = 255,
        MountLooting = 256,
        MountRacecantmount = 257,
        MountShapeshifted = 258,
        MountNoFavorites = 259,
        MountNoMounts = 260,
        DismountNopet = 261,
        DismountNotmounted = 262,
        DismountNotyourpet = 263,
        SpellFailedTotems = 264,
        SpellFailedReagents = 265,
        SpellFailedReagentsGeneric = 266,
        SpellFailedOptionalReagents = 267,
        CantTradeGold = 268,
        SpellFailedEquippedItem = 269,
        SpellFailedEquippedItemClassS = 270,
        SpellFailedShapeshiftFormS = 271,
        SpellFailedAnotherInProgress = 272,
        Badattackfacing = 273,
        Badattackpos = 274,
        ChestInUse = 275,
        UseCantOpen = 276,
        ...
        DoorLocked = 278,
        ButtonLocked = 279,
        UseLockedWithItemS = 280,
        UseLockedWithSpellS = 281,
        UseLockedWithSpellKnownSi = 282,
        UseTooFar = 283,
        UseBadAngle = 284,
        UseObjectMoving = 285,
        UseSpellFocus = 286,
        UseDestroyed = 287,
        SetLootFreeforall = 288,
        SetLootRoundrobin = 289,
        SetLootMaster = 290,
        SetLootGroup = 291,
        SetLootThresholdS = 292,
        NewLootMasterS = 293,
        SpecifyMasterLooter = 294,
        LootSpecChangedS = 295,
        TameFailed = 296,
        ChatWhileDead = 297,
        ChatPlayerNotFoundS = 298,
        Newtaxipath = 299,
        NoPet = 300,
        Notyourpet = 301,
        PetNotRenameable = 302,
        QuestObjectiveCompleteS = 303,
        QuestUnknownComplete = 304,
        QuestAddKillSii = 305,
        QuestAddFoundSii = 306,
        QuestAddItemSii = 307,
        QuestAddPlayerKillSii = 308,
        Cannotcreatedirectory = 309,
        Cannotcreatefile = 310,
        PlayerWrongFaction = 311,
        PlayerIsNeutral = 312,
        BankslotFailedTooMany = 313,
        BankslotInsufficientFunds = 314,
        BankslotNotbanker = 315,
        FriendDbError = 316,
        FriendListFull = 317,
        FriendAddedS = 318,
        BattletagFriendAddedS = 319,
        FriendOnlineSs = 320,
        FriendOfflineS = 321,
        FriendNotFound = 322,
        FriendWrongFaction = 323,
        FriendRemovedS = 324,
        BattletagFriendRemovedS = 325,
        FriendError = 326,
        FriendAlreadyS = 327,
        FriendSelf = 328,
        FriendDeleted = 329,
        ...
        OnlyOneBolt = 338,
        OnlyOneAmmo = 339,
        SpellFailedEquippedSpecificItem = 340,
        WrongBagTypeSubclass = 341,
        CantWrapStackable = 342,
        CantWrapEquipped = 343,
        CantWrapWrapped = 344,
        CantWrapBound = 345,
        CantWrapUnique = 346,
        CantWrapBags = 347,
        ...
        OutOfHolyPower = 358,
        OutOfMaelstrom = 359,
        OutOfComboPoints = 360,
        OutOfInsanity = 361,
        OutOfEssence = 362,
        OutOfArcaneCharges = 363,
        OutOfFury = 364,
        OutOfPain = 365,
        OutOfPowerDisplay = 366,
        LootGone = 367,
        MountForceddismount = 368,
        AutofollowTooFar = 369,
        UnitNotFound = 370,
        InvalidFollowTarget = 371,
        InvalidFollowPvpCombat = 372,
        InvalidFollowTargetPvpCombat = 373,
        InvalidInspectTarget = 374,
        GuildemblemSuccess = 375,
        GuildemblemInvalidTabardColors = 376,
        GuildemblemNoguild = 377,
        GuildemblemNotguildmaster = 378,
        GuildemblemNotenoughmoney = 379,
        GuildemblemInvalidvendor = 380,
        EmblemerrorNotabardgeoset = 381,
        SpellOutOfRange = 382,
        CommandNeedsTarget = 383,
        NoammoS = 384,
        Toobusytofollow = 385,
        DuelRequested = 386,
        DuelCancelled = 387,
        Deathbindalreadybound = 388,
        DeathbindSuccessS = 389,
        Noemotewhilerunning = 390,
        ZoneExplored = 391,
        ZoneExploredXp = 392,
        InvalidItemTarget = 393,
        InvalidQuestTarget = 394,
        IgnoringYouS = 395,
        FishNotHooked = 396,
        FishEscaped = 397,
        SpellFailedNotunsheathed = 398,
        PetitionOfferedS = 399,
        PetitionSigned = 400,
        PetitionSignedS = 401,
        PetitionDeclinedS = 402,
        PetitionAlreadySigned = 403,
        PetitionRestrictedAccountTrial = 404,
        PetitionAlreadySignedOther = 405,
        PetitionInGuild = 406,
        PetitionCreator = 407,
        PetitionNotEnoughSignatures = 408,
        PetitionNotSameServer = 409,
        PetitionFull = 410,
        PetitionAlreadySignedByS = 411,
        GuildNameInvalid = 412,
        SpellUnlearnedS = 413,
        PetSpellRooted = 414,
        PetSpellAffectingCombat = 415,
        PetSpellOutOfRange = 416,
        PetSpellNotBehind = 417,
        PetSpellTargetsDead = 418,
        PetSpellDead = 419,
        PetSpellNopath = 420,
        ItemCantBeDestroyed = 421,
        TicketAlreadyExists = 422,
        TicketCreateError = 423,
        TicketUpdateError = 424,
        TicketDbError = 425,
        TicketNoText = 426,
        TicketTextTooLong = 427,
        ObjectIsBusy = 428,
        ExhaustionWellrested = 429,
        ExhaustionRested = 430,
        ExhaustionNormal = 431,
        ExhaustionTired = 432,
        ExhaustionExhausted = 433,
        NoItemsWhileShapeshifted = 434,
        CantInteractShapeshifted = 435,
        RealmNotFound = 436,
        MailQuestItem = 437,
        MailBoundItem = 438,
        MailConjuredItem = 439,
        MailBag = 440,
        MailToSelf = 441,
        MailTargetNotFound = 442,
        MailDatabaseError = 443,
        MailDeleteItemError = 444,
        MailWrappedCod = 445,
        MailCantSendRealm = 446,
        MailTempReturnOutage = 447,
        MailRecepientCantReceiveMail = 448,
        MailSent = 449,
        MailTargetIsTrial = 450,
        NotHappyEnough = 451,
        UseCantImmune = 452,
        CantBeDisenchanted = 453,
        CantUseDisarmed = 454,
        AuctionDatabaseError = 455,
        AuctionHigherBid = 456,
        AuctionAlreadyBid = 457,
        AuctionOutbidS = 458,
        AuctionWonS = 459,
        AuctionRemovedS = 460,
        AuctionBidPlaced = 461,
        LogoutFailed = 462,
        QuestPushSuccessS = 463,
        QuestPushInvalidS = 464,
        QuestPushInvalidToRecipientS = 465,
        QuestPushAcceptedS = 466,
        QuestPushDeclinedS = 467,
        QuestPushBusyS = 468,
        QuestPushDeadS = 469,
        QuestPushDeadToRecipientS = 470,
        QuestPushLogFullS = 471,
        QuestPushLogFullToRecipientS = 472,
        QuestPushOnquestS = 473,
        QuestPushOnquestToRecipientS = 474,
        QuestPushAlreadyDoneS = 475,
        QuestPushAlreadyDoneToRecipientS = 476,
        QuestPushNotDailyS = 477,
        QuestPushTimerExpiredS = 478,
        QuestPushNotInPartyS = 479,
        QuestPushDifferentServerDailyS = 480,
        QuestPushDifferentServerDailyToRecipientS = 481,
        QuestPushNotAllowedS = 482,
        QuestPushPrerequisiteS = 483,
        QuestPushPrerequisiteToRecipientS = 484,
        QuestPushLowLevelS = 485,
        QuestPushLowLevelToRecipientS = 486,
        QuestPushHighLevelS = 487,
        QuestPushHighLevelToRecipientS = 488,
        QuestPushClassS = 489,
        QuestPushClassToRecipientS = 490,
        QuestPushRaceS = 491,
        QuestPushRaceToRecipientS = 492,
        QuestPushLowFactionS = 493,
        QuestPushLowFactionToRecipientS = 494,
        QuestPushHighFactionS = 495,
        QuestPushHighFactionToRecipientS = 496,
        QuestPushExpansionS = 497,
        QuestPushExpansionToRecipientS = 498,
        QuestPushNotGarrisonOwnerS = 499,
        QuestPushNotGarrisonOwnerToRecipientS = 500,
        QuestPushWrongCovenantS = 501,
        QuestPushWrongCovenantToRecipientS = 502,
        QuestPushNewPlayerExperienceS = 503,
        QuestPushNewPlayerExperienceToRecipientS = 504,
        QuestPushWrongFactionS = 505,
        QuestPushWrongFactionToRecipientS = 506,
        QuestPushCrossFactionRestrictedS = 507,
        RaidGroupLowlevel = 508,
        RaidGroupOnly = 509,
        RaidGroupFull = 510,
        RaidGroupRequirementsUnmatch = 511,
        CorpseIsNotInInstance = 512,
        PvpKillHonorable = 513,
        PvpKillDishonorable = 514,
        SpellFailedAlreadyAtFullHealth = 515,
        SpellFailedAlreadyAtFullMana = 516,
        SpellFailedAlreadyAtFullPowerS = 517,
        AutolootMoneyS = 518,
        GenericStunned = 519,
        GenericThrottle = 520,
        ClubFinderSearchingTooFast = 521,
        TargetStunned = 522,
        MustRepairDurability = 523,
        RaidYouJoined = 524,
        RaidYouLeft = 525,
        InstanceGroupJoinedWithParty = 526,
        InstanceGroupJoinedWithRaid = 527,
        RaidMemberAddedS = 528,
        RaidMemberRemovedS = 529,
        InstanceGroupAddedS = 530,
        InstanceGroupRemovedS = 531,
        ClickOnItemToFeed = 532,
        TooManyChatChannels = 533,
        LootRollPending = 534,
        LootPlayerNotFound = 535,
        NotInRaid = 536,
        LoggingOut = 537,
        TargetLoggingOut = 538,
        NotWhileMounted = 539,
        NotWhileShapeshifted = 540,
        NotInCombat = 541,
        NotWhileDisarmed = 542,
        PetBroken = 543,
        TalentWipeError = 544,
        SpecWipeError = 545,
        GlyphWipeError = 546,
        PetSpecWipeError = 547,
        FeignDeathResisted = 548,
        MeetingStoneInQueueS = 549,
        MeetingStoneLeftQueueS = 550,
        MeetingStoneOtherMemberLeft = 551,
        MeetingStonePartyKickedFromQueue = 552,
        MeetingStoneMemberStillInQueue = 553,
        MeetingStoneSuccess = 554,
        MeetingStoneInProgress = 555,
        MeetingStoneMemberAddedS = 556,
        MeetingStoneGroupFull = 557,
        MeetingStoneNotLeader = 558,
        MeetingStoneInvalidLevel = 559,
        MeetingStoneTargetNotInParty = 560,
        MeetingStoneTargetInvalidLevel = 561,
        MeetingStoneMustBeLeader = 562,
        MeetingStoneNoRaidGroup = 563,
        MeetingStoneNeedParty = 564,
        MeetingStoneNotFound = 565,
        MeetingStoneTargetInVehicle = 566,
        GuildemblemSame = 567,
        EquipTradeItem = 568,
        PvpToggleOn = 569,
        PvpToggleOff = 570,
        GroupJoinBattlegroundDeserters = 571,
        GroupJoinBattlegroundDead = 572,
        GroupJoinBattlegroundS = 573,
        GroupJoinBattlegroundFail = 574,
        GroupJoinBattlegroundTooMany = 575,
        SoloJoinBattlegroundS = 576,
        JoinSingleScenarioS = 577,
        BattlegroundTooManyQueues = 578,
        BattlegroundCannotQueueForRated = 579,
        BattledgroundQueuedForRated = 580,
        BattlegroundTeamLeftQueue = 581,
        BattlegroundNotInBattleground = 582,
        AlreadyInArenaTeamS = 583,
        InvalidPromotionCode = 584,
        BgPlayerJoinedSs = 585,
        BgPlayerLeftS = 586,
        RestrictedAccount = 587,
        RestrictedAccountTrial = 588,
        PlayTimeExceeded = 589,
        ApproachingPartialPlayTime = 590,
        ApproachingPartialPlayTime2 = 591,
        ApproachingNoPlayTime = 592,
        ApproachingNoPlayTime2 = 593,
        UnhealthyTime = 594,
        ChatRestrictedTrial = 595,
        ChatThrottled = 596,
        MailReachedCap = 597,
        InvalidRaidTarget = 598,
        RaidLeaderReadyCheckStartS = 599,
        ReadyCheckInProgress = 600,
        ReadyCheckThrottled = 601,
        DungeonDifficultyFailed = 602,
        DungeonDifficultyChangedS = 603,
        TradeWrongRealm = 604,
        TradeNotOnTaplist = 605,
        ChatPlayerAmbiguousS = 606,
        LootCantLootThatNow = 607,
        LootMasterInvFull = 608,
        LootMasterUniqueItem = 609,
        LootMasterOther = 610,
        FilteringYouS = 611,
        UsePreventedByMechanicS = 612,
        ItemUniqueEquippable = 613,
        LfgLeaderIsLfmS = 614,
        LfgPending = 615,
        CantSpeakLangage = 616,
        VendorMissingTurnins = 617,
        BattlegroundNotInTeam = 618,
        NotInBattleground = 619,
        NotEnoughHonorPoints = 620,
        NotEnoughArenaPoints = 621,
        SocketingRequiresMetaGem = 622,
        SocketingMetaGemOnlyInMetaslot = 623,
        SocketingRequiresHydraulicGem = 624,
        SocketingHydraulicGemOnlyInHydraulicslot = 625,
        SocketingRequiresCogwheelGem = 626,
        SocketingCogwheelGemOnlyInCogwheelslot = 627,
        SocketingItemTooLowLevel = 628,
        ItemMaxCountSocketed = 629,
        SystemDisabled = 630,
        QuestFailedTooManyDailyQuestsI = 631,
        ItemMaxCountEquippedSocketed = 632,
        ItemUniqueEquippableSocketed = 633,
        UserSquelched = 634,
        AccountSilenced = 635,
        PartyMemberSilenced = 636,
        PartyMemberSilencedLfgDelist = 637,
        TooMuchGold = 638,
        NotBarberSitting = 639,
        QuestFailedCais = 640,
        InviteRestrictedTrial = 641,
        VoiceIgnoreFull = 642,
        VoiceIgnoreSelf = 643,
        VoiceIgnoreNotFound = 644,
        VoiceIgnoreAlreadyS = 645,
        VoiceIgnoreAddedS = 646,
        VoiceIgnoreRemovedS = 647,
        VoiceIgnoreAmbiguous = 648,
        VoiceIgnoreDeleted = 649,
        UnknownMacroOptionS = 650,
        NotDuringArenaMatch = 651,
        NotInRatedBattleground = 652,
        PlayerSilenced = 653,
        PlayerUnsilenced = 654,
        ComsatDisconnect = 655,
        ComsatReconnectAttempt = 656,
        ComsatConnectFail = 657,
        MailInvalidAttachmentSlot = 658,
        MailTooManyAttachments = 659,
        MailInvalidAttachment = 660,
        MailAttachmentExpired = 661,
        VoiceChatParentalDisableMic = 662,
        ProfaneChatName = 663,
        PlayerSilencedEcho = 664,
        PlayerUnsilencedEcho = 665,
        LootCantLootThat = 666,
        ArenaExpiredCais = 667,
        GroupActionThrottled = 668,
        AlreadyPickpocketed = 669,
        NameInvalid = 670,
        NameNoName = 671,
        NameTooShort = 672,
        NameTooLong = 673,
        NameMixedLanguages = 674,
        NameProfane = 675,
        NameReserved = 676,
        NameThreeConsecutive = 677,
        NameInvalidSpace = 678,
        NameConsecutiveSpaces = 679,
        NameRussianConsecutiveSilentCharacters = 680,
        NameRussianSilentCharacterAtBeginningOrEnd = 681,
        NameDeclensionDoesntMatchBaseName = 682,
        RecruitAFriendNotLinked = 683,
        RecruitAFriendNotNow = 684,
        RecruitAFriendSummonLevelMax = 685,
        RecruitAFriendSummonCooldown = 686,
        RecruitAFriendSummonOffline = 687,
        RecruitAFriendInsufExpanLvl = 688,
        RecruitAFriendMapIncomingTransferNotAllowed = 689,
        NotSameAccount = 690,
        BadOnUseEnchant = 691,
        TradeSelf = 692,
        TooManySockets = 693,
        ItemMaxLimitCategoryCountExceededIs = 694,
        TradeTargetMaxLimitCategoryCountExceededIs = 695,
        ItemMaxLimitCategorySocketedExceededIs = 696,
        ItemMaxLimitCategoryEquippedExceededIs = 697,
        ShapeshiftFormCannotEquip = 698,
        ItemInventoryFullSatchel = 699,
        ScalingStatItemLevelExceeded = 700,
        ScalingStatItemLevelTooLow = 701,
        PurchaseLevelTooLow = 702,
        GroupSwapFailed = 703,
        InviteInCombat = 704,
        InvalidGlyphSlot = 705,
        GenericNoValidTargets = 706,
        CalendarEventAlertS = 707,
        PetLearnSpellS = 708,
        PetLearnAbilityS = 709,
        PetSpellUnlearnedS = 710,
        InviteUnknownRealm = 711,
        InviteNoPartyServer = 712,
        InvitePartyBusy = 713,
        InvitePartyBusyPendingRequest = 714,
        InvitePartyBusyPendingSuggest = 715,
        PartyTargetAmbiguous = 716,
        PartyLfgInviteRaidLocked = 717,
        PartyLfgBootLimit = 718,
        PartyLfgBootCooldownS = 719,
        PartyLfgBootNotEligibleS = 720,
        PartyLfgBootInpatientTimerS = 721,
        PartyLfgBootInProgress = 722,
        PartyLfgBootTooFewPlayers = 723,
        PartyLfgBootVoteSucceeded = 724,
        PartyLfgBootVoteFailed = 725,
        PartyLfgBootDisallowedByMap = 726,
        PartyLfgBootDungeonComplete = 727,
        PartyLfgBootLootRolls = 728,
        PartyLfgBootVoteRegistered = 729,
        PartyPrivateGroupOnly = 730,
        PartyLfgTeleportInCombat = 731,
        PartyTimeRunningSeasonIdMustMatch = 732,
        RaidDisallowedByLevel = 733,
        RaidDisallowedByCrossRealm = 734,
        PartyRoleNotAvailable = 735,
        JoinLfgObjectFailed = 736,
        LfgRemovedLevelup = 737,
        LfgRemovedXpToggle = 738,
        LfgRemovedFactionChange = 739,
        BattlegroundInfoThrottled = 740,
        BattlegroundAlreadyIn = 741,
        ArenaTeamChangeFailedQueued = 742,
        ArenaTeamPermissions = 743,
        NotWhileFalling = 744,
        NotWhileMoving = 745,
        NotWhileFatigued = 746,
        MaxSockets = 747,
        MultiCastActionTotemS = 748,
        BattlegroundJoinLevelup = 749,
        RemoveFromPvpQueueXpGain = 750,
        BattlegroundJoinXpGain = 751,
        BattlegroundJoinMercenary = 752,
        BattlegroundJoinTooManyHealers = 753,
        BattlegroundJoinRatedTooManyHealers = 754,
        BattlegroundJoinTooManyTanks = 755,
        BattlegroundJoinTooManyDamage = 756,
        RaidDifficultyFailed = 757,
        RaidDifficultyChangedS = 758,
        LegacyRaidDifficultyChangedS = 759,
        RaidLockoutChangedS = 760,
        RaidConvertedToParty = 761,
        PartyConvertedToRaid = 762,
        PlayerDifficultyChangedS = 763,
        GmresponseDbError = 764,
        BattlegroundJoinRangeIndex = 765,
        ArenaJoinRangeIndex = 766,
        RemoveFromPvpQueueFactionChange = 767,
        BattlegroundJoinFailed = 768,
        BattlegroundJoinNoValidSpecForRole = 769,
        BattlegroundJoinRespec = 770,
        BattlegroundInvitationDeclined = 771,
        BattlegroundInvitationDeclinedBy = 772,
        BattlegroundJoinTimedOut = 773,
        BattlegroundDupeQueue = 774,
        BattlegroundJoinMustCompleteQuest = 775,
        InBattlegroundRespec = 776,
        MailLimitedDurationItem = 777,
        YellRestrictedTrial = 778,
        ChatRaidRestrictedTrial = 779,
        LfgRoleCheckFailed = 780,
        LfgRoleCheckFailedTimeout = 781,
        LfgRoleCheckFailedNotViable = 782,
        LfgReadyCheckFailed = 783,
        LfgReadyCheckFailedTimeout = 784,
        LfgGroupFull = 785,
        LfgNoLfgObject = 786,
        LfgNoSlotsPlayer = 787,
        LfgNoSlotsParty = 788,
        LfgNoSpec = 789,
        LfgMismatchedSlots = 790,
        LfgMismatchedSlotsLocalXrealm = 791,
        LfgPartyPlayersFromDifferentRealms = 792,
        LfgMembersNotPresent = 793,
        LfgGetInfoTimeout = 794,
        LfgInvalidSlot = 795,
        LfgDeserterPlayer = 796,
        LfgDeserterParty = 797,
        LfgDead = 798,
        LfgRandomCooldownPlayer = 799,
        LfgRandomCooldownParty = 800,
        LfgTooManyMembers = 801,
        LfgTooFewMembers = 802,
        LfgProposalFailed = 803,
        LfgProposalDeclinedSelf = 804,
        LfgProposalDeclinedParty = 805,
        LfgNoSlotsSelected = 806,
        LfgNoRolesSelected = 807,
        LfgRoleCheckInitiated = 808,
        LfgReadyCheckInitiated = 809,
        LfgPlayerDeclinedRoleCheck = 810,
        LfgPlayerDeclinedReadyCheck = 811,
        LfgJoinedQueue = 812,
        LfgJoinedFlexQueue = 813,
        LfgJoinedRfQueue = 814,
        LfgJoinedScenarioQueue = 815,
        LfgJoinedWorldPvpQueue = 816,
        LfgJoinedBattlefieldQueue = 817,
        LfgJoinedList = 818,
        LfgLeftQueue = 819,
        LfgLeftList = 820,
        LfgRoleCheckAborted = 821,
        LfgReadyCheckAborted = 822,
        LfgCantUseBattleground = 823,
        LfgCantUseDungeons = 824,
        LfgReasonTooManyLfg = 825,
        LfgFarmLimit = 826,
        LfgNoCrossFactionParties = 827,
        InvalidTeleportLocation = 828,
        TooFarToInteract = 829,
        BattlegroundPlayersFromDifferentRealms = 830,
        DifficultyChangeCooldownS = 831,
        DifficultyChangeCombatCooldownS = 832,
        DifficultyChangeWorldstate = 833,
        DifficultyChangeEncounter = 834,
        DifficultyChangeCombat = 835,
        DifficultyChangePlayerBusy = 836,
        DifficultyChangePlayerOnVehicle = 837,
        DifficultyChangeAlreadyStarted = 838,
        DifficultyChangeOtherHeroicS = 839,
        DifficultyChangeHeroicInstanceAlreadyRunning = 840,
        ArenaTeamPartySize = 841,
        SoloShuffleWargameGroupSize = 842,
        SoloShuffleWargameGroupComp = 843,
        SoloMinItemLevel = 844,
        PvpPlayerAbandoned = 845,
        BattlegroundJoinGroupQueueWithoutHealer = 846,
        QuestForceRemovedS = 847,
        AttackNoActions = 848,
        InRandomBg = 849,
        InNonRandomBg = 850,
        BnFriendSelf = 851,
        BnFriendAlready = 852,
        BnFriendBlocked = 853,
        BnFriendListFull = 854,
        BnFriendRequestSent = 855,
        BnBroadcastThrottle = 856,
        BgDeveloperOnly = 857,
        CurrencySpellSlotMismatch = 858,
        CurrencyNotTradable = 859,
        RequiresExpansionS = 860,
        QuestFailedSpell = 861,
        TalentFailedUnspentTalentPoints = 862,
        TalentFailedNotEnoughTalentsInPrimaryTree = 863,
        TalentFailedNoPrimaryTreeSelected = 864,
        TalentFailedCantRemoveTalent = 865,
        TalentFailedUnknown = 866,
        TalentFailedInCombat = 867,
        TalentFailedInPvpMatch = 868,
        TalentFailedInMythicPlus = 869,
        WargameRequestFailure = 870,
        RankRequiresAuthenticator = 871,
        GuildBankVoucherFailed = 872,
        WargameRequestSent = 873,
        RequiresAchievementI = 874,
        RefundResultExceedMaxCurrency = 875,
        CantBuyQuantity = 876,
        ItemIsBattlePayLocked = 877,
        PartyAlreadyInBattlegroundQueue = 878,
        PartyConfirmingBattlegroundQueue = 879,
        BattlefieldTeamPartySize = 880,
        InsuffTrackedCurrencyIs = 881,
        NotOnTournamentRealm = 882,
        GuildTrialAccountTrial = 883,
        GuildTrialAccountVeteran = 884,
        GuildUndeletableDueToLevel = 885,
        CantDoThatInAGroup = 886,
        GuildLeaderReplaced = 887,
        TransmogrifyCantEquip = 888,
        TransmogrifyInvalidItemType = 889,
        TransmogrifyNotSoulbound = 890,
        TransmogrifyInvalidSource = 891,
        TransmogrifyInvalidDestination = 892,
        TransmogrifyMismatch = 893,
        TransmogrifyLegendary = 894,
        TransmogrifySameItem = 895,
        TransmogrifySameAppearance = 896,
        TransmogrifyNotEquipped = 897,
        VoidDepositFull = 898,
        VoidWithdrawFull = 899,
        VoidStorageWrapped = 900,
        VoidStorageStackable = 901,
        VoidStorageUnbound = 902,
        VoidStorageRepair = 903,
        VoidStorageCharges = 904,
        VoidStorageQuest = 905,
        VoidStorageConjured = 906,
        VoidStorageMail = 907,
        VoidStorageBag = 908,
        VoidTransferStorageFull = 909,
        VoidTransferInvFull = 910,
        VoidTransferInternalError = 911,
        VoidTransferItemInvalid = 912,
        DifficultyDisabledInLfg = 913,
        VoidStorageUnique = 914,
        VoidStorageLoot = 915,
        VoidStorageHoliday = 916,
        VoidStorageDuration = 917,
        VoidStorageLoadFailed = 918,
        VoidStorageInvalidItem = 919,
        ParentalControlsChatMuted = 920,
        SorStartExperienceIncomplete = 921,
        SorInvalidEmail = 922,
        SorInvalidComment = 923,
        ChallengeModeResetCooldownS = 924,
        ChallengeModeResetKeystone = 925,
        PetJournalAlreadyInLoadout = 926,
        ReportSubmittedSuccessfully = 927,
        ReportSubmissionFailed = 928,
        SuggestionSubmittedSuccessfully = 929,
        BugSubmittedSuccessfully = 930,
        ChallengeModeEnabled = 931,
        ChallengeModeDisabled = 932,
        PetbattleCreateFailed = 933,
        PetbattleNotHere = 934,
        PetbattleNotHereOnTransport = 935,
        PetbattleNotHereUnevenGround = 936,
        PetbattleNotHereObstructed = 937,
        PetbattleNotWhileInCombat = 938,
        PetbattleNotWhileDead = 939,
        PetbattleNotWhileFlying = 940,
        PetbattleTargetInvalid = 941,
        PetbattleTargetOutOfRange = 942,
        PetbattleTargetNotCapturable = 943,
        PetbattleNotATrainer = 944,
        PetbattleDeclined = 945,
        PetbattleInBattle = 946,
        PetbattleInvalidLoadout = 947,
        PetbattleAllPetsDead = 948,
        PetbattleNoPetsInSlots = 949,
        PetbattleNoAccountLock = 950,
        PetbattleWildPetTapped = 951,
        PetbattleRestrictedAccount = 952,
        PetbattleOpponentNotAvailable = 953,
        PetbattleNotWhileInMatchedBattle = 954,
        CantHaveMorePetsOfThatType = 955,
        CantHaveMorePets = 956,
        PvpMapNotFound = 957,
        PvpMapNotSet = 958,
        PetbattleQueueQueued = 959,
        PetbattleQueueAlreadyQueued = 960,
        PetbattleQueueJoinFailed = 961,
        PetbattleQueueJournalLock = 962,
        PetbattleQueueRemoved = 963,
        PetbattleQueueProposalDeclined = 964,
        PetbattleQueueProposalTimeout = 965,
        PetbattleQueueOpponentDeclined = 966,
        PetbattleQueueRequeuedInternal = 967,
        PetbattleQueueRequeuedRemoved = 968,
        PetbattleQueueSlotLocked = 969,
        PetbattleQueueSlotEmpty = 970,
        PetbattleQueueSlotNoTracker = 971,
        PetbattleQueueSlotNoSpecies = 972,
        PetbattleQueueSlotCantBattle = 973,
        PetbattleQueueSlotRevoked = 974,
        PetbattleQueueSlotDead = 975,
        PetbattleQueueSlotNoPet = 976,
        PetbattleQueueNotWhileNeutral = 977,
        PetbattleGameTimeLimitWarning = 978,
        PetbattleGameRoundsLimitWarning = 979,
        HasRestriction = 980,
        ItemUpgradeItemTooLowLevel = 981,
        ItemUpgradeNoPath = 982,
        ItemUpgradeNoMoreUpgrades = 983,
        BonusRollEmpty = 984,
        ChallengeModeFull = 985,
        ChallengeModeInProgress = 986,
        ChallengeModeIncorrectKeystone = 987,
        BattletagFriendNotFound = 988,
        BattletagFriendNotValid = 989,
        BattletagFriendNotAllowed = 990,
        BattletagFriendThrottled = 991,
        BattletagFriendSuccess = 992,
        PetTooHighLevelToUncage = 993,
        PetbattleInternal = 994,
        CantCagePetYet = 995,
        NoLootInChallengeMode = 996,
        QuestPetBattleVictoriesPvpIi = 997,
        RoleCheckAlreadyInProgress = 998,
        RecruitAFriendAccountLimit = 999,
        RecruitAFriendFailed = 1000,
        SetLootPersonal = 1001,
        SetLootMethodFailedCombat = 1002,
        ReagentBankFull = 1003,
        ReagentBankLocked = 1004,
        GarrisonBuildingExists = 1005,
        GarrisonInvalidPlot = 1006,
        GarrisonInvalidBuildingid = 1007,
        GarrisonInvalidPlotBuilding = 1008,
        GarrisonRequiresBlueprint = 1009,
        GarrisonNotEnoughCurrency = 1010,
        GarrisonNotEnoughGold = 1011,
        GarrisonCompleteMissionWrongFollowerType = 1012,
        AlreadyUsingLfgList = 1013,
        RestrictedAccountLfgListTrial = 1014,
        ToyUseLimitReached = 1015,
        ToyAlreadyKnown = 1016,
        TransmogSetAlreadyKnown = 1017,
        NotEnoughCurrency = 1018,
        SpecIsDisabled = 1019,
        FeatureRestrictedTrial = 1020,
        CantBeObliterated = 1021,
        CantBeScrapped = 1022,
        CantBeRecrafted = 1023,
        ArtifactRelicDoesNotMatchArtifact = 1024,
        MustEquipArtifact = 1025,
        CantDoThatRightNow = 1026,
        AffectingCombat = 1027,
        EquipmentManagerCombatSwapS = 1028,
        EquipmentManagerBagsFull = 1029,
        EquipmentManagerMissingItemS = 1030,
        MovieRecordingWarningPerf = 1031,
        MovieRecordingWarningDiskFull = 1032,
        MovieRecordingWarningNoMovie = 1033,
        MovieRecordingWarningRequirements = 1034,
        MovieRecordingWarningCompressing = 1035,
        NoChallengeModeReward = 1036,
        ClaimedChallengeModeReward = 1037,
        ChallengeModePeriodResetSs = 1038,
        CantDoThatChallengeModeActive = 1039,
        TalentFailedRestArea = 1040,
        CannotAbandonLastPet = 1041,
        TestCvarSetSss = 1042,
        QuestTurnInFailReason = 1043,
        ClaimedChallengeModeRewardOld = 1044,
        TalentGrantedByAura = 1045,
        ChallengeModeAlreadyComplete = 1046,
        GlyphTargetNotAvailable = 1047,
        PvpWarmodeToggleOn = 1048,
        PvpWarmodeToggleOff = 1049,
        SpellFailedLevelRequirement = 1050,
        SpellFailedCantFlyHere = 1051,
        BattlegroundJoinRequiresLevel = 1052,
        BattlegroundJoinDisqualified = 1053,
        BattlegroundJoinDisqualifiedNoName = 1054,
        VoiceChatGenericUnableToConnect = 1055,
        VoiceChatServiceLost = 1056,
        VoiceChatChannelNameTooShort = 1057,
        VoiceChatChannelNameTooLong = 1058,
        VoiceChatChannelAlreadyExists = 1059,
        VoiceChatTargetNotFound = 1060,
        VoiceChatTooManyRequests = 1061,
        VoiceChatPlayerSilenced = 1062,
        VoiceChatParentalDisableAll = 1063,
        VoiceChatDisabled = 1064,
        NoPvpReward = 1065,
        ClaimedPvpReward = 1066,
        AzeriteEssenceSelectionFailedEssenceNotUnlocked = 1067,
        AzeriteEssenceSelectionFailedCantRemoveEssence = 1068,
        AzeriteEssenceSelectionFailedConditionFailed = 1069,
        AzeriteEssenceSelectionFailedRestArea = 1070,
        AzeriteEssenceSelectionFailedSlotLocked = 1071,
        AzeriteEssenceSelectionFailedNotAtForge = 1072,
        AzeriteEssenceSelectionFailedHeartLevelTooLow = 1073,
        AzeriteEssenceSelectionFailedNotEquipped = 1074,
        SocketingRequiresPunchcardredGem = 1075,
        SocketingPunchcardredGemOnlyInPunchcardredslot = 1076,
        SocketingRequiresPunchcardyellowGem = 1077,
        SocketingPunchcardyellowGemOnlyInPunchcardyellowslot = 1078,
        SocketingRequiresPunchcardblueGem = 1079,
        SocketingPunchcardblueGemOnlyInPunchcardblueslot = 1080,
        SocketingRequiresDominationShard = 1081,
        SocketingDominationShardOnlyInDominationslot = 1082,
        SocketingRequiresCypherGem = 1083,
        SocketingCypherGemOnlyInCypherslot = 1084,
        SocketingRequiresTinkerGem = 1085,
        SocketingTinkerGemOnlyInTinkerslot = 1086,
        SocketingRequiresPrimordialGem = 1087,
        SocketingPrimordialGemOnlyInPrimordialslot = 1088,
        LevelLinkingResultLinked = 1089,
        LevelLinkingResultUnlinked = 1090,
        ClubFinderErrorPostClub = 1091,
        ClubFinderErrorApplyClub = 1092,
        ClubFinderErrorRespondApplicant = 1093,
        ClubFinderErrorCancelApplication = 1094,
        ClubFinderErrorTypeAcceptApplication = 1095,
        ClubFinderErrorTypeNoInvitePermissions = 1096,
        ClubFinderErrorTypeNoPostingPermissions = 1097,
        ClubFinderErrorTypeApplicantList = 1098,
        ClubFinderErrorTypeApplicantListNoPerm = 1099,
        ClubFinderErrorTypeFinderNotAvailable = 1100,
        ClubFinderErrorTypeGetPostingIds = 1101,
        ClubFinderErrorTypeJoinApplication = 1102,
        ClubFinderErrorTypeRealmNotEligible = 1103,
        ClubFinderErrorTypeFlaggedRename = 1104,
        ClubFinderErrorTypeFlaggedDescriptionChange = 1105,
        ItemInteractionNotEnoughGold = 1106,
        ItemInteractionNotEnoughCurrency = 1107,
        ItemInteractionNoConversionOutput = 1108,
        PlayerChoiceErrorPendingChoice = 1109,
        SoulbindInvalidConduit = 1110,
        SoulbindInvalidConduitItem = 1111,
        SoulbindInvalidTalent = 1112,
        SoulbindDuplicateConduit = 1113,
        ActivateSoulbindS = 1114,
        ActivateSoulbindFailedRestArea = 1115,
        CantUseProfanity = 1116,
        NotInPetBattle = 1117,
        NotInNpe = 1118,
        NoSpec = 1119,
        NoDominationshardOverwrite = 1120,
        UseWeeklyRewardsDisabled = 1121,
        CrossFactionGroupJoined = 1122,
        CantTargetUnfriendlyInOverworld = 1123,
        EquipablespellsSlotsFull = 1124,
        ItemModAppearanceGroupAlreadyKnown = 1125,
        CantBulkSellItemWithRefund = 1126,
        WowLabsPartyErrorTypePartyIsFull = 1127,
        WowLabsPartyErrorTypeMaxInviteSent = 1128,
        WowLabsPartyErrorTypePlayerAlreadyInvited = 1129,
        WowLabsPartyErrorTypePartyInviteInvalid = 1130,
        WowLabsLobbyMatchmakerErrorEnterQueueFailed = 1131,
        WowLabsLobbyMatchmakerErrorLeaveQueueFailed = 1132,
        TargetIsSelfFoundCannotTrade = 1133,
        PlayerIsSelfFoundCannotTrade = 1134,
        MailRecepientIsSelfFoundCannotReceiveMail = 1135,
        PlayerIsSelfFoundCannotSendMail = 1136,
        PlayerIsSelfFoundCannotUseAuctionHouse = 1137,
        MailTargetCannotReceiveMail = 1138,
    }

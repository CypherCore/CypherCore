...
namespace Framework.Constants
{
    ...
    public enum Emote
    {
        ...
        StateReadAndSit = 616,
        StateReadySpellDirected = 617,
        StateReadyThrownNoSound = 618,
        ...
        StateWorkChopwoodLumberAxe2 = 1008,
        ...
        StateShovel = 1083,
        StateLean = 1084,
        StateReadyspellomniInterruptable = 1089,
        OneshotWalean01Var1 = 1093,
        OneshotWalean01Var0 = 1094,
        StateFlychannelcastomni2 = 1097,
        StateArtoffloopHidesWeapon = 1100,
        StateWorkHerbalismHaranirPainting = 1101,
        StateSpellChannelOmniUp = 1103,
        StateWaarmscrossed = 1110,
        OneshotParryFist1h = 1111,
        StateWahang02 = 1112,
        StateWorkHousingHammerSound = 1113,
        StateWacradle = 1115,
        StateWacratehold2 = 1116,
        StateWorkHammerHaranirPainting = 1117,
        StateWorkHerbalismHousingScythe = 1118,
        StateWorkMiningHousing = 1119,
        OneshotTalkSubduedNoSheathe = 1120,
        StateWalean02NoInterrupt = 1121,
        StateWorkBluntImpact = 1122,
        OneshotArtdualloop = 1125,
        StateArtdualloop = 1126,
        StateWorkZulamanChoppingWood = 1128,

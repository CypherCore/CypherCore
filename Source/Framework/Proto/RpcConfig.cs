...
namespace Bgs.Protocol.Config {
    ...
    static RpcConfigReflection() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            ...
            "YW5jZRgEIAEoDRIWCg5zdGFydHVwX3BlcmlvZBgFIAEoAiJJCg1Qcm90b2Nv",
            "bEFsaWFzEhsKE3NlcnZlcl9zZXJ2aWNlX25hbWUYASACKAkSGwoTY2xpZW50",
            "X3NlcnZpY2VfbmFtZRgCIAIoCSJMCg5TZXJ2aWNlQWxpYXNlcxI6Cg5wcm90",
            "b2NvbF9hbGlhcxgBIAMoCzIiLmJncy5wcm90b2NvbC5jb25maWcuUHJvdG9j",
            "b2xBbGlhc0ICSAE="));
  ...
  #endif
  {
    ...
    [global::System.CodeDom.Compiler.GeneratedCode("protoc", null)]
    void pb::IBufferMessage.InternalWriteTo(ref pb::WriteContext output) {
      protocolAlias_.WriteTo(ref output, _repeated_protocolAlias_codec);
      if (_unknownFields != null) {
        _unknownFields.WriteTo(ref output);
      }
    }
    ...
    void pb::IBufferMessage.InternalMergeFrom(ref pb::ParseContext input) {
      ...
      switch(tag) {
          default:
            ...
            break;
          case 10: {
            protocolAlias_.AddEntriesFrom(ref input, _repeated_protocolAlias_codec);
            break;
          }
        }
      }

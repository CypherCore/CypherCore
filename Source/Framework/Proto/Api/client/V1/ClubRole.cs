...
namespace Bgs.Protocol.Club.V1.Client {
    ...
    static ClubRoleReflection() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            ...
            "L2NsaWVudC9yb2xlX3R5cGVzLnByb3RvIrEMChBDbHViUHJpdmlsZWdlU2V0",
            ...
            "CBIgChhjYW5fc2V0X3Zpc2liaWxpdHlfbGV2ZWwYECABKAgSGAoQY2FuX3Nl",
            "dF90aW1lem9uZRgRIAEoCBIWCg5jYW5fc2V0X2xvY2FsZRgSIAEoCBIUCgxj",
            "YW5fc2V0X3RhZ3MYEyABKAgSFgoOY2FuX2FkZF9tZW1iZXIYHSABKAgSFwoP",
            "Y2FuX2tpY2tfbWVtYmVyGB4gASgIEiQKHGNhbl9zZXRfb3duX21lbWJlcl9h",
            "dHRyaWJ1dGUYHyABKAgSJgoeY2FuX3NldF9vdGhlcl9tZW1iZXJfYXR0cmli",
            "dXRlGCAgASgIEh8KF2Nhbl9zZXRfb3duX3ZvaWNlX3N0YXRlGCEgASgIEiIK",
            "GmNhbl9zZXRfb3duX3ByZXNlbmNlX2xldmVsGCIgASgIEiEKGWNhbl9zZXRf",
            "b3duX3doaXNwZXJfbGV2ZWwYIyABKAgSHwoXY2FuX3NldF9vd25fbWVtYmVy",
            "X25vdGUYJCABKAgSIQoZY2FuX3NldF9vdGhlcl9tZW1iZXJfbm90ZRglIAEo",
            "CBIVCg1jYW5fdXNlX3ZvaWNlGDIgASgIEiUKHWNhbl92b2ljZV9tdXRlX21l",
            "bWJlcl9mb3JfYWxsGDMgASgIEhoKEmNhbl9nZXRfaW52aXRhdGlvbhhGIAEo",
            "CBIbChNjYW5fc2VuZF9pbnZpdGF0aW9uGEcgASgIEiEKGWNhbl9zZW5kX2d1",
            "ZXN0X2ludml0YXRpb24YSCABKAgSIQoZY2FuX3Jldm9rZV9vd25faW52aXRh",
            "dGlvbhhJIAEoCBIjChtjYW5fcmV2b2tlX290aGVyX2ludml0YXRpb24YSiAB",
            "KAgSGgoSY2FuX2dldF9zdWdnZXN0aW9uGFogASgIEhoKEmNhbl9zdWdnZXN0",
            "X21lbWJlchhbIAEoCBIaChJjYW5fYXBwcm92ZV9tZW1iZXIYXCABKAgSFgoO",
            "Y2FuX2dldF90aWNrZXQYbiABKAgSGQoRY2FuX2NyZWF0ZV90aWNrZXQYbyAB",
            "KAgSGgoSY2FuX2Rlc3Ryb3lfdGlja2V0GHAgASgIEhQKC2Nhbl9nZXRfYmFu",
            "GIIBIAEoCBIUCgtjYW5fYWRkX2JhbhiDASABKAgSFwoOY2FuX3JlbW92ZV9i",
            "YW4YhAEgASgIEhoKEWNhbl9jcmVhdGVfc3RyZWFtGIwBIAEoCBIbChJjYW5f",
            "ZGVzdHJveV9zdHJlYW0YjQEgASgIEiAKF2Nhbl9zZXRfc3RyZWFtX3Bvc2l0",
            "aW9uGI4BIAEoCBIhChhjYW5fc2V0X3N0cmVhbV9hdHRyaWJ1dGUYjwEgASgI",
            "EhwKE2Nhbl9zZXRfc3RyZWFtX25hbWUYkAEgASgIEh8KFmNhbl9zZXRfc3Ry",
            "ZWFtX3N1YmplY3QYkQEgASgIEh4KFWNhbl9zZXRfc3RyZWFtX2FjY2VzcxiS",
            "ASABKAgSIwoaY2FuX3NldF9zdHJlYW1fdm9pY2VfbGV2ZWwYkwEgASgIEhsK",
            "EmNhbl9jcmVhdGVfbWVzc2FnZRi0ASABKAgSIAoXY2FuX2Rlc3Ryb3lfb3du",
            "X21lc3NhZ2UYtQEgASgIEiIKGWNhbl9kZXN0cm95X290aGVyX21lc3NhZ2UY",
            "tgEgASgIEh0KFGNhbl9lZGl0X293bl9tZXNzYWdlGLcBIAEoCBIYCg9jYW5f",
            "cGluX21lc3NhZ2UYuAEgASgIEhgKD2Nhbl9tZW50aW9uX2FsbBi5ASABKAgS",
            "GQoQY2FuX21lbnRpb25faGVyZRi6ASABKAgSGwoSY2FuX21lbnRpb25fbWVt",
            "YmVyGLsBIAEoCBIZChBjYW5fbWVudGlvbl9yb2xlGLwBIAEoCCLAAQoIQ2x1",
            "YlJvbGUSCgoCaWQYASABKA0SJgoFc3RhdGUYAiABKAsyFy5iZ3MucHJvdG9j",
            "b2wuUm9sZVN0YXRlEkAKCXByaXZpbGVnZRgDIAEoCzItLmJncy5wcm90b2Nv",
            "bC5jbHViLnYxLmNsaWVudC5DbHViUHJpdmlsZWdlU2V0EiIKGmFsd2F5c19n",
            "cmFudF9zdHJlYW1fYWNjZXNzGAQgASgIEhoKEmFsbG93X2luX2NsdWJfc2xv",
            "dBgFIAEoCCKbAQoLQ2x1YlJvbGVTZXQSMwoEcm9sZRgBIAMoCzIlLmJncy5w",
            "cm90b2NvbC5jbHViLnYxLmNsaWVudC5DbHViUm9sZRIYCgxkZWZhdWx0X3Jv",
            "bGUYBSADKA1CAhABEiwKJGFzc2lnbm1lbnRfcmVzcGVjdHNfcmVsZWdhdGlv",
            "bl9jaGFpbhgGIAEoCBIPCgdzdWJ0eXBlGAcgASgJQgJIAQ=="));
      descriptor = pbr::FileDescriptor.FromGeneratedCode(descriptorData,
          new pbr::FileDescriptor[] { global::Bgs.Protocol.RoleTypesReflection.Descriptor, },
          new pbr::GeneratedClrTypeInfo(null, null, new pbr::GeneratedClrTypeInfo[] {
            new pbr::GeneratedClrTypeInfo(typeof(global::Bgs.Protocol.Club.V1.Client.ClubPrivilegeSet), global::Bgs.Protocol.Club.V1.Client.ClubPrivilegeSet.Parser, new[]{ "CanDestroy", "CanSetAttribute", "CanSetName", "CanSetDescription", "CanSetAvatar", "CanSetBroadcast", "CanSetPrivacyLevel", "CanSetVisibilityLevel", "CanSetTimezone", "CanSetLocale", "CanSetTags", "CanAddMember", "CanKickMember", "CanSetOwnMemberAttribute", "CanSetOtherMemberAttribute", "CanSetOwnVoiceState", "CanSetOwnPresenceLevel", "CanSetOwnWhisperLevel", "CanSetOwnMemberNote", "CanSetOtherMemberNote", "CanUseVoice", "CanVoiceMuteMemberForAll", "CanGetInvitation", "CanSendInvitation", "CanSendGuestInvitation", "CanRevokeOwnInvitation", "CanRevokeOtherInvitation", "CanGetSuggestion", "CanSuggestMember", "CanApproveMember", "CanGetTicket", "CanCreateTicket", "CanDestroyTicket", "CanGetBan", "CanAddBan", "CanRemoveBan", "CanCreateStream", "CanDestroyStream", "CanSetStreamPosition", "CanSetStreamAttribute", "CanSetStreamName", "CanSetStreamSubject", "CanSetStreamAccess", "CanSetStreamVoiceLevel", "CanCreateMessage", "CanDestroyOwnMessage", "CanDestroyOtherMessage", "CanEditOwnMessage", "CanPinMessage", "CanMentionAll", "CanMentionHere", "CanMentionMember", "CanMentionRole" }, null, null, null, null),
  ...
  #endif
  {
    ...
    public ClubPrivilegeSet(ClubPrivilegeSet other) : this() {
      ...
      canSetVisibilityLevel_ = other.canSetVisibilityLevel_;
      canSetTimezone_ = other.canSetTimezone_;
      canSetLocale_ = other.canSetLocale_;
      canSetTags_ = other.canSetTags_;
    ...
    /// <summary>Field number for the "can_set_visibility_level" field.</summary>
    public const int CanSetVisibilityLevelFieldNumber = 16;
    private readonly static bool CanSetVisibilityLevelDefaultValue = false;

    private bool canSetVisibilityLevel_;
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    [global::System.CodeDom.Compiler.GeneratedCode("protoc", null)]
    public bool CanSetVisibilityLevel {
      get { if ((_hasBits0 & 128) != 0) { return canSetVisibilityLevel_; } else { return CanSetVisibilityLevelDefaultValue; } }
      set {
        _hasBits0 |= 128;
        canSetVisibilityLevel_ = value;
      }
    }
    /// <summary>Gets whether the "can_set_visibility_level" field is set</summary>
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    [global::System.CodeDom.Compiler.GeneratedCode("protoc", null)]
    public bool HasCanSetVisibilityLevel {
      get { return (_hasBits0 & 128) != 0; }
    }
    /// <summary>Clears the value of the "can_set_visibility_level" field</summary>
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    [global::System.CodeDom.Compiler.GeneratedCode("protoc", null)]
    public void ClearCanSetVisibilityLevel() {
      _hasBits0 &= ~128;
    }

    /// <summary>Field number for the "can_set_timezone" field.</summary>
    public const int CanSetTimezoneFieldNumber = 17;
    private readonly static bool CanSetTimezoneDefaultValue = false;

    private bool canSetTimezone_;
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    [global::System.CodeDom.Compiler.GeneratedCode("protoc", null)]
    public bool CanSetTimezone {
      get { if ((_hasBits0 & 256) != 0) { return canSetTimezone_; } else { return CanSetTimezoneDefaultValue; } }
      set {
        _hasBits0 |= 256;
        canSetTimezone_ = value;
      }
    }
    /// <summary>Gets whether the "can_set_timezone" field is set</summary>
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    [global::System.CodeDom.Compiler.GeneratedCode("protoc", null)]
    public bool HasCanSetTimezone {
      get { return (_hasBits0 & 256) != 0; }
    }
    /// <summary>Clears the value of the "can_set_timezone" field</summary>
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    [global::System.CodeDom.Compiler.GeneratedCode("protoc", null)]
    public void ClearCanSetTimezone() {
      _hasBits0 &= ~256;
    }

    /// <summary>Field number for the "can_set_locale" field.</summary>
    public const int CanSetLocaleFieldNumber = 18;
    private readonly static bool CanSetLocaleDefaultValue = false;

    private bool canSetLocale_;
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    [global::System.CodeDom.Compiler.GeneratedCode("protoc", null)]
    public bool CanSetLocale {
      get { if ((_hasBits0 & 512) != 0) { return canSetLocale_; } else { return CanSetLocaleDefaultValue; } }
      set {
        _hasBits0 |= 512;
        canSetLocale_ = value;
      }
    }
    /// <summary>Gets whether the "can_set_locale" field is set</summary>
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    [global::System.CodeDom.Compiler.GeneratedCode("protoc", null)]
    public bool HasCanSetLocale {
      get { return (_hasBits0 & 512) != 0; }
    }
    /// <summary>Clears the value of the "can_set_locale" field</summary>
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    [global::System.CodeDom.Compiler.GeneratedCode("protoc", null)]
    public void ClearCanSetLocale() {
      _hasBits0 &= ~512;
    }

    /// <summary>Field number for the "can_set_tags" field.</summary>
    public const int CanSetTagsFieldNumber = 19;
    private readonly static bool CanSetTagsDefaultValue = false;

    private bool canSetTags_;
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    [global::System.CodeDom.Compiler.GeneratedCode("protoc", null)]
    public bool CanSetTags {
      get { if ((_hasBits0 & 1024) != 0) { return canSetTags_; } else { return CanSetTagsDefaultValue; } }
      set {
        _hasBits0 |= 1024;
        canSetTags_ = value;
      }
    }
    /// <summary>Gets whether the "can_set_tags" field is set</summary>
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    [global::System.CodeDom.Compiler.GeneratedCode("protoc", null)]
    public bool HasCanSetTags {
      get { return (_hasBits0 & 1024) != 0; }
    }
    /// <summary>Clears the value of the "can_set_tags" field</summary>
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    [global::System.CodeDom.Compiler.GeneratedCode("protoc", null)]
    public void ClearCanSetTags() {
      _hasBits0 &= ~1024;
    }
    ...
    public bool CanAddMember {
      get { if ((_hasBits0 & 2048) != 0) { return canAddMember_; } else { return CanAddMemberDefaultValue; } }
      set {
        _hasBits0 |= 2048;
        canAddMember_ = value;
      }
    ...
    public bool CanKickMember {
      get { if ((_hasBits0 & 4096) != 0) { return canKickMember_; } else { return CanKickMemberDefaultValue; } }
      set {
        _hasBits0 |= 4096;
    ...
    public bool CanSetOwnMemberAttribute {
      get { if ((_hasBits0 & 8192) != 0) { return canSetOwnMemberAttribute_; } else { return CanSetOwnMemberAttributeDefaultValue; } }
      set {
        _hasBits0 |= 8192;
    ...
    public bool CanSetOtherMemberAttribute {
      get { if ((_hasBits0 & 16384) != 0) { return canSetOtherMemberAttribute_; } else { return CanSetOtherMemberAttributeDefaultValue; } }
      set {
        _hasBits0 |= 16384;
    ...
    public bool CanSetOwnVoiceState {
      get { if ((_hasBits0 & 32768) != 0) { return canSetOwnVoiceState_; } else { return CanSetOwnVoiceStateDefaultValue; } }
      set {
        _hasBits0 |= 32768;
    ...
    public bool CanSetOwnPresenceLevel {
      get { if ((_hasBits0 & 65536) != 0) { return canSetOwnPresenceLevel_; } else { return CanSetOwnPresenceLevelDefaultValue; } }
      set {
        _hasBits0 |= 65536;
    ...
    public bool CanSetOwnWhisperLevel {
      get { if ((_hasBits0 & 131072) != 0) { return canSetOwnWhisperLevel_; } else { return CanSetOwnWhisperLevelDefaultValue; } }
      set {
        _hasBits0 |= 131072;
    ...
    public bool CanSetOwnMemberNote {
      get { if ((_hasBits0 & 262144) != 0) { return canSetOwnMemberNote_; } else { return CanSetOwnMemberNoteDefaultValue; } }
      set {
        _hasBits0 |= 262144;
    ...
    public bool CanSetOtherMemberNote {
      get { if ((_hasBits0 & 524288) != 0) { return canSetOtherMemberNote_; } else { return CanSetOtherMemberNoteDefaultValue; } }
      set {
        _hasBits0 |= 524288;
    ...
    public bool CanUseVoice {
      get { if ((_hasBits0 & 1048576) != 0) { return canUseVoice_; } else { return CanUseVoiceDefaultValue; } }
      set {
        _hasBits0 |= 1048576;
        canUseVoice_ = value;
      }
    ...
    public bool CanVoiceMuteMemberForAll {
      get { if ((_hasBits0 & 2097152) != 0) { return canVoiceMuteMemberForAll_; } else { return CanVoiceMuteMemberForAllDefaultValue; } }
      set {
        _hasBits0 |= 2097152;
    ...
    public bool CanGetInvitation {
      get { if ((_hasBits0 & 4194304) != 0) { return canGetInvitation_; } else { return CanGetInvitationDefaultValue; } }
      set {
        _hasBits0 |= 4194304;
    ...
    public bool CanSendInvitation {
      get { if ((_hasBits0 & 8388608) != 0) { return canSendInvitation_; } else { return CanSendInvitationDefaultValue; } }
      set {
        _hasBits0 |= 8388608;
    ...
    public bool CanSendGuestInvitation {
      get { if ((_hasBits0 & 16777216) != 0) { return canSendGuestInvitation_; } else { return CanSendGuestInvitationDefaultValue; } }
      set {
        _hasBits0 |= 16777216;
    ...
    public bool CanRevokeOwnInvitation {
      get { if ((_hasBits0 & 33554432) != 0) { return canRevokeOwnInvitation_; } else { return CanRevokeOwnInvitationDefaultValue; } }
      set {
        _hasBits0 |= 33554432;
    ...
    public bool CanRevokeOtherInvitation {
      get { if ((_hasBits0 & 67108864) != 0) { return canRevokeOtherInvitation_; } else { return CanRevokeOtherInvitationDefaultValue; } }
      set {
        _hasBits0 |= 67108864;
    ...
    public bool CanGetSuggestion {
      get { if ((_hasBits0 & 134217728) != 0) { return canGetSuggestion_; } else { return CanGetSuggestionDefaultValue; } }
      set {
        _hasBits0 |= 134217728;
    ...
    public bool CanSuggestMember {
      get { if ((_hasBits0 & 268435456) != 0) { return canSuggestMember_; } else { return CanSuggestMemberDefaultValue; } }
      set {
        _hasBits0 |= 268435456;
    ...
    public bool CanApproveMember {
      get { if ((_hasBits0 & 536870912) != 0) { return canApproveMember_; } else { return CanApproveMemberDefaultValue; } }
      set {
        _hasBits0 |= 536870912;
    ...
    public bool CanGetTicket {
      get { if ((_hasBits0 & 1073741824) != 0) { return canGetTicket_; } else { return CanGetTicketDefaultValue; } }
      set {
    ...
    public bool CanCreateTicket {
      get { if ((_hasBits0 & -2147483648) != 0) { return canCreateTicket_; } else { return CanCreateTicketDefaultValue; } }
      set {
    ...
    public bool CanDestroyTicket {
      get { if ((_hasBits1 & 1) != 0) { return canDestroyTicket_; } else { return CanDestroyTicketDefaultValue; } }
      set {
        _hasBits1 |= 1;
    ...
    public bool CanGetBan {
      get { if ((_hasBits1 & 2) != 0) { return canGetBan_; } else { return CanGetBanDefaultValue; } }
      set {
        _hasBits1 |= 2;
        canGetBan_ = value;
      }
    ...
    public bool CanAddBan {
      get { if ((_hasBits1 & 4) != 0) { return canAddBan_; } else { return CanAddBanDefaultValue; } }
      set {
        _hasBits1 |= 4;
        canAddBan_ = value;
      }
    ...
    public bool CanRemoveBan {
      get { if ((_hasBits1 & 8) != 0) { return canRemoveBan_; } else { return CanRemoveBanDefaultValue; } }
      set {
        _hasBits1 |= 8;
        canRemoveBan_ = value;
      }
    ...
    public bool CanCreateStream {
      get { if ((_hasBits1 & 16) != 0) { return canCreateStream_; } else { return CanCreateStreamDefaultValue; } }
      set {
        _hasBits1 |= 16;
    ...
    public bool CanDestroyStream {
      get { if ((_hasBits1 & 32) != 0) { return canDestroyStream_; } else { return CanDestroyStreamDefaultValue; } }
      set {
        _hasBits1 |= 32;
    ...
    public bool CanSetStreamPosition {
      get { if ((_hasBits1 & 64) != 0) { return canSetStreamPosition_; } else { return CanSetStreamPositionDefaultValue; } }
      set {
        _hasBits1 |= 64;
    ...
    public bool CanSetStreamAttribute {
      get { if ((_hasBits1 & 128) != 0) { return canSetStreamAttribute_; } else { return CanSetStreamAttributeDefaultValue; } }
      set {
        _hasBits1 |= 128;
    ...
    public bool CanSetStreamName {
      get { if ((_hasBits1 & 256) != 0) { return canSetStreamName_; } else { return CanSetStreamNameDefaultValue; } }
      set {
        _hasBits1 |= 256;
    ...
    public bool CanSetStreamSubject {
      get { if ((_hasBits1 & 512) != 0) { return canSetStreamSubject_; } else { return CanSetStreamSubjectDefaultValue; } }
      set {
        _hasBits1 |= 512;
    ...
    public bool CanSetStreamAccess {
      get { if ((_hasBits1 & 1024) != 0) { return canSetStreamAccess_; } else { return CanSetStreamAccessDefaultValue; } }
      set {
        _hasBits1 |= 1024;
    ...
    public bool CanSetStreamVoiceLevel {
      get { if ((_hasBits1 & 2048) != 0) { return canSetStreamVoiceLevel_; } else { return CanSetStreamVoiceLevelDefaultValue; } }
      set {
        _hasBits1 |= 2048;
    ...
    public bool CanCreateMessage {
      get { if ((_hasBits1 & 4096) != 0) { return canCreateMessage_; } else { return CanCreateMessageDefaultValue; } }
      set {
        _hasBits1 |= 4096;
    ...
    public bool CanDestroyOwnMessage {
      get { if ((_hasBits1 & 8192) != 0) { return canDestroyOwnMessage_; } else { return CanDestroyOwnMessageDefaultValue; } }
      set {
        _hasBits1 |= 8192;
    ...
    public bool CanDestroyOtherMessage {
      get { if ((_hasBits1 & 16384) != 0) { return canDestroyOtherMessage_; } else { return CanDestroyOtherMessageDefaultValue; } }
      set {
        _hasBits1 |= 16384;
    ...
    public bool CanEditOwnMessage {
      get { if ((_hasBits1 & 32768) != 0) { return canEditOwnMessage_; } else { return CanEditOwnMessageDefaultValue; } }
      set {
        _hasBits1 |= 32768;
    ...
    public bool CanPinMessage {
      get { if ((_hasBits1 & 65536) != 0) { return canPinMessage_; } else { return CanPinMessageDefaultValue; } }
      set {
        _hasBits1 |= 65536;
    ...
    public bool CanMentionAll {
      get { if ((_hasBits1 & 131072) != 0) { return canMentionAll_; } else { return CanMentionAllDefaultValue; } }
      set {
        _hasBits1 |= 131072;
    ...
    public bool CanMentionHere {
      get { if ((_hasBits1 & 262144) != 0) { return canMentionHere_; } else { return CanMentionHereDefaultValue; } }
      set {
        _hasBits1 |= 262144;
    ...
    public bool CanMentionMember {
      get { if ((_hasBits1 & 524288) != 0) { return canMentionMember_; } else { return CanMentionMemberDefaultValue; } }
      set {
        _hasBits1 |= 524288;
    ...
    public bool CanMentionRole {
      get { if ((_hasBits1 & 1048576) != 0) { return canMentionRole_; } else { return CanMentionRoleDefaultValue; } }
      set {
        _hasBits1 |= 1048576;
    ...
    public bool Equals(ClubPrivilegeSet other) {
      ...
      if (CanSetVisibilityLevel != other.CanSetVisibilityLevel) return false;
      if (CanSetTimezone != other.CanSetTimezone) return false;
      if (CanSetLocale != other.CanSetLocale) return false;
      if (CanSetTags != other.CanSetTags) return false;
    ...
    public override int GetHashCode() {
      ...
      if (HasCanSetVisibilityLevel) hash ^= CanSetVisibilityLevel.GetHashCode();
      if (HasCanSetTimezone) hash ^= CanSetTimezone.GetHashCode();
      if (HasCanSetLocale) hash ^= CanSetLocale.GetHashCode();
      if (HasCanSetTags) hash ^= CanSetTags.GetHashCode();
    ...
    public void WriteTo(pb::CodedOutputStream output) {
      ...
      if (HasCanSetVisibilityLevel) {
        output.WriteRawTag(128, 1);
        output.WriteBool(CanSetVisibilityLevel);
      }
      if (HasCanSetTimezone) {
        output.WriteRawTag(136, 1);
        output.WriteBool(CanSetTimezone);
      }
      if (HasCanSetLocale) {
        output.WriteRawTag(144, 1);
        output.WriteBool(CanSetLocale);
      }
      if (HasCanSetTags) {
        output.WriteRawTag(152, 1);
        output.WriteBool(CanSetTags);
      }
      if (HasCanAddMember) {
    ...
    public void MergeFrom(ClubPrivilegeSet other) {
      ...
      if (other.HasCanSetVisibilityLevel) {
        CanSetVisibilityLevel = other.CanSetVisibilityLevel;
      }
      if (other.HasCanSetTimezone) {
        CanSetTimezone = other.CanSetTimezone;
      }
      if (other.HasCanSetLocale) {
        CanSetLocale = other.CanSetLocale;
      }
      if (other.HasCanSetTags) {
        CanSetTags = other.CanSetTags;
      }
    ...
    public void MergeFrom(pb::CodedInputStream input) {
      ...
      switch(tag) {
          ...
          case 128: {
            CanSetVisibilityLevel = input.ReadBool();
            break;
          }
          case 136: {
            CanSetTimezone = input.ReadBool();
            break;
          }
          case 144: {
            CanSetLocale = input.ReadBool();
            break;
          }
          case 152: {
            CanSetTags = input.ReadBool();
            break;
          }
          case 232: {

...
namespace Framework.Database
{
	public class SQLQueryHolder<T>
	{
		...
		private Dictionary<T, SQLResult> _results = new();
	...
	{
		private SQLQueryHolder<R> _holder;
		private TaskCompletionSource<SQLQueryHolder<R>> _result;
	...
	public class SQLQueryHolderCallback<R> : ISqlCallback
	{
		...
		private Task<SQLQueryHolder<R>> _future;

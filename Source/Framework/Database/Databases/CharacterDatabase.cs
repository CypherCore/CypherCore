...
namespace Framework.Database
{
    public class CharacterDatabase : MySqlBase<CharStatements>
    {
        public override void PreparedStatements()
        {
            ...
            PrepareStatement(CharStatements.INS_TRANSMOG_OUTFIT_2, "INSERT INTO character_transmog_outfit (guid, transmogOutfitId, name, icon, situationsEnabled) VALUES (?, ?, ?, ?, ?)");
            ...
            PrepareStatement(CharStatements.SEL_CHAR_RACE_OR_FACTION_CHANGE_INFOS, "SELECT c.at_login, c.knownTitles, gm.guid, c.map FROM characters c LEFT JOIN group_member gm ON c.guid = gm.memberGuid WHERE c.guid = ?");
            ...
            PrepareStatement(CharStatements.SEL_MAIL_ITEMS_BY_ENTRY, "SELECT mi.item_guid, m.sender, m.receiver, cs.account AS sender_account, cs.name AS sender_name, cr.account AS receiver_account, cr.name AS receiver_name " +
            ...
            PrepareStatement(CharStatements.DEL_CHAR_TRANSMOG_OUTFIT_BY_CHAR, "DELETE FROM character_transmog_outfit WHERE guid = ?");
            PrepareStatement(CharStatements.DEL_CHAR_TRANSMOG_OUTFIT_SITUATION_BY_CHAR, "DELETE FROM character_transmog_outfit_slot WHERE guid = ?");
            PrepareStatement(CharStatements.DEL_CHAR_TRANSMOG_OUTFIT_SLOT_BY_CHAR, "DELETE FROM character_transmog_outfit_situation WHERE guid = ?");
            ...
            PrepareStatement(CharStatements.UPD_CHAR_QUESTSTATUS_REWARDED_ACTIVE_BY_QUEST, "UPDATE character_queststatus_rewarded SET active = 0 WHERE guid = ? AND quest = ?");
    ...
    public enum CharStatements
    {
        ...
        SEL_CHARACTER_TRANSMOG_OUTFIT,
        SEL_CHARACTER_TRANSMOG_OUTFIT_SITUATION,
        SEL_CHARACTER_TRANSMOG_OUTFIT_SLOT,
        ...
        INS_TRANSMOG_OUTFIT_2,
        DEL_TRANSMOG_OUTFIT_2,
        INS_TRANSMOG_OUTFIT_SITUATION,
        DEL_TRANSMOG_OUTFIT_SITUATION,
        INS_TRANSMOG_OUTFIT_SLOT,
        DEL_TRANSMOG_OUTFIT_SLOT,
        ...
        DEL_CHAR_TRANSMOG_OUTFIT_BY_CHAR,
        DEL_CHAR_TRANSMOG_OUTFIT_SITUATION_BY_CHAR,
        DEL_CHAR_TRANSMOG_OUTFIT_SLOT_BY_CHAR,
